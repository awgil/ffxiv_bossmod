...
class BitingWind(BossModule module) : Components.VoidzoneAtCastTarget(module, 5, AID.Gust, m => m.Enemies(OID.BitingWind).Where(z => z.EventState != 7), 0.9f);
...
[ModuleInfo(Contributors = "LegendofIceman, Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 900, NameID = 12263)]
