...
class P2IcyVoidzone(BossModule module) : Components.Voidzone(module, 5, OID.IcyVoidzone);
...
class P2SouthernCrossVoidzone(BossModule module) : Components.Voidzone(module, 6, OID.SouthernCrossVoidzone);
