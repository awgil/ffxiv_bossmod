...
class SurpriseBalloon(BossModule module, AID aid) : Components.KnockbackFromCastTarget(module, aid, 13);
...
class FaerieRing(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeDonut(6, 12)); // TODO: verify inner radius
...
[ModuleInfo(PrimaryActorOID = (uint)OID.NBoss, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 979, NameID = 12506, SortOrder = 9, PlanLevel = 90)]
public class C033NStatice(WorldState ws, Actor primary) : C033Statice(ws, primary);

[ModuleInfo(PrimaryActorOID = (uint)OID.SBoss, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 980, NameID = 12506, SortOrder = 9, PlanLevel = 90)]
