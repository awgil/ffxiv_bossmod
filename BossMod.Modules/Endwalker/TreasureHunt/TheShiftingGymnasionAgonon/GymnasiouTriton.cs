...
class FoulWaters(BossModule module) : Components.VoidzoneAtCastTarget(module, 5, AID.FoulWaters, OID.Bubble, 0);
...
[ModuleInfo(Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 909, NameID = 12006)]
