...
class InfernoBlast(BossModule module) : Components.StandardAOEs(module, AID.InfernoBlast, new AOEShapeRect(46, 20));
class Roar(BossModule module) : Components.StandardAOEs(module, AID.Roar, new AOEShapeCircle(12));
class FlareStar(BossModule module) : Components.StandardAOEs(module, AID.FlareStar, new AOEShapeCircle(12));
class MarkOfTheBeast(BossModule module) : Components.StandardAOEs(module, AID.MarkOfTheBeast, new AOEShapeCone(8, 60.Degrees()));
class Pounce(BossModule module) : Components.SingleTargetCast(module, AID.Pounce);
class MagmaChamber(BossModule module) : Components.StandardAOEs(module, AID.MagmaChamber2, 8);
...
[ModuleInfo(Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 909, NameID = 11997)]
