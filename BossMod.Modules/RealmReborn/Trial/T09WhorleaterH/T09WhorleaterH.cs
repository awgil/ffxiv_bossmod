...
class Hydroshot(BossModule module) : Components.VoidzoneAtCastTarget(module, 5, AID.Hydroshot, m => m.Enemies(OID.HydroshotZone).Where(z => z.EventState != 7), 0);
class Dreadstorm(BossModule module) : Components.VoidzoneAtCastTarget(module, 5, AID.Dreadstorm, m => m.Enemies(OID.DreadstormZone).Where(z => z.EventState != 7), 0);
