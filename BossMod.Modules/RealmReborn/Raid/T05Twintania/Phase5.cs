...
class P5LiquidHell(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.LiquidHellBoss, m => m.Enemies(OID.LiquidHell).Where(z => z.EventState != 7), 1.5f)
{
