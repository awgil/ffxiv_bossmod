...
// P1 mechanics
class P1LiquidHellAdds(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.LiquidHellAdds, m => m.Enemies(OID.LiquidHell).Where(z => z.EventState != 7), 0); // note: voidzone appears ~1.2s after cast ends, but we want to try avoiding initial damage too
