...
class GaolerVoidzone(BossModule module) : Components.PersistentVoidzone(module, 5, OID.GaolerVoidzone, e => e.EventState == 7);

[ModuleInfo(GroupType = BossModuleInfo.GroupType.CFC, GroupID = 64, NameID = 1801, PlanLevel = 50)]
