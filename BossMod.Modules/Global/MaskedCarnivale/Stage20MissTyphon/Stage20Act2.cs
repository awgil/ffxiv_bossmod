...
class Waterspout(BossModule module) : Components.StandardAOEs(module, AID.Waterspout, 4);
...
[ModuleInfo(Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.MaskedCarnivale, GroupID = 630, NameID = 7111, SortOrder = 2)]
