...
class SludgeVoidzone(BossModule module) : Components.Voidzone(module, 9.8f, OID.SludgeVoidzone, z => z.EventState == 7);
...
[ModuleInfo(Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 676, NameID = 8301)]
