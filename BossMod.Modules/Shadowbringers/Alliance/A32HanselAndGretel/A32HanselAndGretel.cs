...
class MagicalConfluence(BossModule module) : Components.Voidzone(module, 4, OID.MagicalConfluence, e => e.EventState == 7, 8);
...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.CFC, GroupID = 779, NameID = 9989, PrimaryActorOID = (uint)OID.Gretel)]
