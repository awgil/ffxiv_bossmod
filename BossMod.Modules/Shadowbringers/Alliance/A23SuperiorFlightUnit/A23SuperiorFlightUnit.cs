...
class IncendiaryBombing(BossModule module) : Components.VoidzoneAtCastTarget(module, 8, AID.IncendiaryBombing, OID.IncendiaryBomb, 0.8f);
...
class IncendiaryBarrage(BossModule module) : Components.VoidzoneAtCastTarget(module, 27, AID.IncendiaryBarrage, 0x1EB07B, 0.8f);
...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.CFC, GroupID = 736, NameID = 9364, PrimaryActorOID = (uint)OID.Alpha)]
