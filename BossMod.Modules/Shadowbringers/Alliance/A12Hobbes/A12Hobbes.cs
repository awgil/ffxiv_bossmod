...
class ShockingDischarge(BossModule module) : Components.VoidzoneAtCastTarget(module, 5, AID.ShockingDischarge, 0x1EAEE6, 1.03f);
...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.CFC, GroupID = 700, NameID = 9143)]
