...
class Whirlwind(BossModule module) : Components.Voidzone(module, 6, OID.Whirlwind, x => x.IsDead);
...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.Quest, GroupID = 68786, NameID = 8489)]
