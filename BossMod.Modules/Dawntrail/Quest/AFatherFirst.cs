...
class BurningSunPuddle(BossModule module) : Components.Voidzone(module, 6, OID.BurningSunPuddle);
...
[ModuleInfo(Contributors = "xan", GroupType = BossModuleInfo.GroupType.Quest, GroupID = 70419, NameID = 12675, PlanLevel = 94)]
