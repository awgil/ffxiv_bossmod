...
class FireScourgeOfFireVoidzone(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.FireScourgeOfFire, module => module.Enemies(OID.ScourgeOfFireVoidzone).Where(z => z.EventState != 7), 0.9f);
