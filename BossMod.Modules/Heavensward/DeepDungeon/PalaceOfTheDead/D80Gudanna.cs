...
class Maelstrom(BossModule module) : Components.Voidzone(module, 10, OID.Tornado);
...
[ModuleInfo(Contributors = "legendoficeman, Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 206, NameID = 5333)]
