...
class BallofFire(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.BallOfFire, m => m.Enemies(OID.FireVoidPuddle).Where(z => z.EventState != 7), 2.1f);
class BallofIce(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.BallOfIce, m => m.Enemies(OID.IceVoidPuddle).Where(z => z.EventState != 7), 2.1f);
...
[ModuleInfo(Contributors = "LegendofIceman", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 176, NameID = 5012)]
