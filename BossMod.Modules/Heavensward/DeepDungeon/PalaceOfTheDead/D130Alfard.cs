...
class BallofFire(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.BallOfFire, OID.FireVoidPuddle, 2.1f);
class BallofIce(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.BallOfIce, OID.IceVoidPuddle, 2.1f);
