...
class Douse(BossModule module) : Components.VoidzoneAtCastTarget(module, 8, AID.Douse, OID.Voidzone, 0.8f);
...
[ModuleInfo(Contributors = "LegendofIceman", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 215, NameID = 5449)]
