...
class Maelstrom(BossModule module) : Components.PersistentVoidzone(module, 10, OID.TornadoVoidZones);
...
[ModuleInfo(Contributors = "LegendofIceman", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 216, NameID = 5461, PlanLevel = 60)]
