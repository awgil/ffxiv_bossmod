...
class PolarRoar(BossModule module) : Components.StandardAOEs(module, AID.PolarRoar, new AOEShapeDonut(9, 40));
class Hellstorm(BossModule module) : Components.StandardAOEs(module, AID.Hellstorm2, 10);
class Netherwind(BossModule module) : Components.StandardAOEs(module, AID.Netherwind, new AOEShapeRect(18, 2));
class GlassyNova(BossModule module) : Components.StandardAOEs(module, AID.GlassyNova, new AOEShapeRect(45.4f, 4));
class BrainFreeze(BossModule module) : Components.StandardAOEs(module, AID.BrainFreeze, new AOEShapeCircle(15.4f));
...
[ModuleInfo(Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 586, NameID = 7590)]
