...
class Ribbit(BossModule module) : Components.StandardAOEs(module, AID.Ribbit, new AOEShapeCone(19.5f, 75.Degrees()));
class SpellbladeThunderIII(BossModule module) : Components.StandardAOEs(module, AID.SpellbladeThunderIII, new AOEShapeRect(60, 3));
class SpellbladeBlizzardIII(BossModule module) : Components.StandardAOEs(module, AID.SpellbladeBlizzardIII, new AOEShapeCircle(9));
class SpellbladeFireIII(BossModule module) : Components.StandardAOEs(module, AID.SpellbladeFireIII, new AOEShapeDonut(4, 15));
class CrossReaper(BossModule module) : Components.StandardAOEs(module, AID.CrossReaper, new AOEShapeCircle(10));
class TheQueensWaltz1(BossModule module) : Components.StandardAOEs(module, AID.TheQueensWaltz1, new AOEShapeCone(34, 10.Degrees()));
...
[ModuleInfo(Contributors = "VeraNala", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 254, NameID = 5633)]
