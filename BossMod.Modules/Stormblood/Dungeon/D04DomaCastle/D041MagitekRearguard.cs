...
class CermetPile(BossModule module) : Components.StandardAOEs(module, AID.CermetPile, new AOEShapeRect(40f + 3.5f, 3));
...
class MagitekRay(BossModule module) : Components.StandardAOEs(module, AID.MagitekRay, new AOEShapeRect(45f + 3.5f, 1));
class SelfDetonate(BossModule module) : Components.StandardAOEs(module, AID.SelfDetonate, new AOEShapeCircle(6));
...
[ModuleInfo(Contributors = "VeraNala", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 241, NameID = 6200)]
