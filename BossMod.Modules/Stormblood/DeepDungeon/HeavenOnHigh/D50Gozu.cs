...
class VoidSpark(BossModule module) : Components.PersistentVoidzone(module, 8, OID.Gloom, z => z.EventState == 7);
...
[ModuleInfo(Contributors = "LegendofIceman", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 544, NameID = 7485)]
