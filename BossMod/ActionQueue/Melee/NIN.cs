...
{
    public static readonly uint[] UnlockQuests = [65680, 65681, 65748, 65750, 65752, 65768, 65770, 67220, 67221, 67222, 67224, 68488];
    ...
    public static bool Unlocked(AID id, int level, int questProgress) => id switch
    {
        ...
        AID.Ten1 => level >= 30 && questProgress > 2,
        AID.Ten2 => level >= 30 && questProgress > 2,
        AID.RabbitMedium => level >= 30 && questProgress > 2,
        AID.FumaShuriken1 => level >= 30 && questProgress > 2,
        AID.FumaShuriken2 => level >= 30 && questProgress > 2,
        AID.FumaShuriken3 => level >= 30 && questProgress > 2,
        AID.FumaShuriken4 => level >= 30 && questProgress > 2,
        AID.Ninjutsu => level >= 30 && questProgress > 2,
        AID.ArmsLength => level >= 32,
        AID.Raiton1 => level >= 35 && questProgress > 3,
        AID.Raiton2 => level >= 35 && questProgress > 3,
        AID.Chi1 => level >= 35 && questProgress > 3,
        AID.Chi2 => level >= 35 && questProgress > 3,
        AID.Katon1 => level >= 35 && questProgress > 3,
        AID.Katon2 => level >= 35 && questProgress > 3,
        AID.DeathBlossom => level >= 38,
        AID.Assassinate => level >= 40,
        AID.Shukuchi => level >= 40 && questProgress > 4,
        AID.Hyoton1 => level >= 45 && questProgress > 5,
        AID.Hyoton2 => level >= 45 && questProgress > 5,
        AID.Suiton1 => level >= 45 && questProgress > 5,
        AID.Suiton2 => level >= 45 && questProgress > 5,
        AID.Doton1 => level >= 45 && questProgress > 5,
        AID.Doton2 => level >= 45 && questProgress > 5,
        AID.Huton1 => level >= 45 && questProgress > 5,
        AID.Huton2 => level >= 45 && questProgress > 5,
        AID.Jin1 => level >= 45 && questProgress > 5,
        AID.Jin2 => level >= 45 && questProgress > 5,
