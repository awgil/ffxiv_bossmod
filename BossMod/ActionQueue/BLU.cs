...
public sealed class Definitions : IDefinitions
{
    ...
    {
        defs.RegisterSpell(AID.Whistle);
        defs.RegisterSpell(AID.TheRoseOfDestruction);
        defs.RegisterSpell(AID.DivineCataract);
        defs.RegisterSpell(AID.ChelonianGate);
        defs.RegisterSpell(AID.AngelsSnack);
        defs.RegisterSpell(AID.FeculentFlood);
        defs.RegisterSpell(AID.SaintlyBeam);
        defs.RegisterSpell(AID.StotramDamage);
        defs.RegisterSpell(AID.StotramHeal);
        defs.RegisterSpell(AID.WhiteDeath);
        defs.RegisterSpell(AID.ColdFog);
        defs.RegisterSpell(AID.TatamiGaeshi);
        defs.RegisterSpell(AID.Tingle);
        defs.RegisterSpell(AID.TripleTrident);
        defs.RegisterSpell(AID.AethericMimicryReleaseTank);
        defs.RegisterSpell(AID.AethericMimicryReleaseDPS);
        defs.RegisterSpell(AID.AethericMimicryReleaseHealer);
        defs.RegisterSpell(AID.BasicInstinct);
        defs.RegisterSpell(AID.Quasar);
        defs.RegisterSpell(AID.Surpanakha);
        defs.RegisterSpell(AID.AethericMimicry);
        defs.RegisterSpell(AID.CondensedLibra);
        defs.RegisterSpell(AID.Devour);
        defs.RegisterSpell(AID.Reflux);
        defs.RegisterSpell(AID.Exuviation);
        defs.RegisterSpell(AID.AngelWhisper);
        defs.RegisterSpell(AID.RevengeBlast);
        defs.RegisterSpell(AID.Cactguard);
        defs.RegisterSpell(AID.PerpetualRay);
        defs.RegisterSpell(AID.Launcher);
        defs.RegisterSpell(AID.Level5Death);
        defs.RegisterSpell(AID.BlackKnightsTour);
        defs.RegisterSpell(AID.JKick, instantAnimLock: 0.90f); // animLock=0.900
        defs.RegisterSpell(AID.WhiteKnightsTour);
        defs.RegisterSpell(AID.Ultravibration);
        defs.RegisterSpell(AID.MustardBomb);
        defs.RegisterSpell(AID.SeaShanty);
        defs.RegisterSpell(AID.MortalFlame);
        defs.RegisterSpell(AID.CandyCane);
        defs.RegisterSpell(AID.LaserEye);
        defs.RegisterSpell(AID.WingedReprobation);
        defs.RegisterSpell(AID.ForceField);
        defs.RegisterSpell(AID.ConvictionMarcato);
        defs.RegisterSpell(AID.DimensionalShift);
        defs.RegisterSpell(AID.DivinationRune);
        defs.RegisterSpell(AID.RubyDynamics);
        defs.RegisterSpell(AID.DeepClean);
        defs.RegisterSpell(AID.PeatPelt);
        defs.RegisterSpell(AID.WildRage);
        defs.RegisterSpell(AID.BreathOfMagic);
        defs.RegisterSpell(AID.Blaze);
        defs.RegisterSpell(AID.Rehydration);
        defs.RegisterSpell(AID.RightRound);
        defs.RegisterSpell(AID.GoblinPunch);
        defs.RegisterSpell(AID.Nightbloom);
        defs.RegisterSpell(AID.PhantomFlurry);
        defs.RegisterSpell(AID.PhantomFlurryEnd);
        defs.RegisterSpell(AID.BothEnds);
        defs.RegisterSpell(AID.PeripheralSynthesis);
        defs.RegisterSpell(AID.MatraMagic);
        defs.RegisterSpell(AID.ChocoMeteor);
        defs.RegisterSpell(AID.MaledictionOfWater);
        defs.RegisterSpell(AID.HydroPull);
        defs.RegisterSpell(AID.AetherialSpark);
        defs.RegisterSpell(AID.DragonForce);
        defs.RegisterSpell(AID.Schiltron);
        defs.RegisterSpell(AID.Apokalypsis);
        defs.RegisterSpell(AID.BeingMortal);
        defs.RegisterSpell(AID.FrogLegs);
        defs.RegisterSpell(AID.ToadOil);
        defs.RegisterSpell(AID.Transfusion);
        defs.RegisterSpell(AID.SelfDestruct, instantAnimLock: 1.60f, castAnimLock: 1.60f); // animLock=1.600s?
        defs.RegisterSpell(AID.FinalSting);
        defs.RegisterSpell(AID.WhiteWind);
        defs.RegisterSpell(AID.Missile);
        defs.RegisterSpell(AID.Glower);
        defs.RegisterSpell(AID.Faze);
        defs.RegisterSpell(AID.FlameThrower);
        defs.RegisterSpell(AID.Loom);
        defs.RegisterSpell(AID.SharpenedKnife);
        defs.RegisterSpell(AID.TheLook);
        defs.RegisterSpell(AID.DrillCannons);
        defs.RegisterSpell(AID.SonicBoom);
        defs.RegisterSpell(AID.ThousandNeedles);
        defs.RegisterSpell(AID.BloodDrain);
        defs.RegisterSpell(AID.MindBlast);
        defs.RegisterSpell(AID.Bristle);
        defs.RegisterSpell(AID.AcornBomb);
        defs.RegisterSpell(AID.Plaincracker);
        defs.RegisterSpell(AID.AquaBreath);
        defs.RegisterSpell(AID.FlyingFrenzy);
        defs.RegisterSpell(AID.BadBreath);
        defs.RegisterSpell(AID.HighVoltage);
        defs.RegisterSpell(AID.SongOfTorment);
        defs.RegisterSpell(AID.WaterCannon);
        defs.RegisterSpell(AID.FourTonzeWeight);
        defs.RegisterSpell(AID.Snort);
        defs.RegisterSpell(AID.BombToss);
        defs.RegisterSpell(AID.StickyTongue);
        defs.RegisterSpell(AID.OffGuard);
        defs.RegisterSpell(AID.Level5Petrify);
        defs.RegisterSpell(AID.Avail);
        defs.RegisterSpell(AID.MagicHammer);
        defs.RegisterSpell(AID.Gobskin);
        defs.RegisterSpell(AID.PomCure);
        defs.RegisterSpell(AID.EerieSoundwave);
        defs.RegisterSpell(AID.Chirp);
        defs.RegisterSpell(AID.AbyssalTransfixion);
        defs.RegisterSpell(AID.Kaltstrahl);
        defs.RegisterSpell(AID.Electrogenesis);
        defs.RegisterSpell(AID.Northerlies);
        defs.RegisterSpell(AID.ProteanWave);
        defs.RegisterSpell(AID.AlpineDraft);
        defs.RegisterSpell(AID.VeilOfTheWhorl);
        defs.RegisterSpell(AID.TailScrew);
        defs.RegisterSpell(AID.ShockStrike);
        defs.RegisterSpell(AID.GlassDance);
        defs.RegisterSpell(AID.MountainBuster);
        defs.RegisterSpell(AID.MoonFlute);
        defs.RegisterSpell(AID.Doom);
        defs.RegisterSpell(AID.MightyGuard);
        defs.RegisterSpell(AID.IceSpikes);
        defs.RegisterSpell(AID.TheDragonsVoice);
        defs.RegisterSpell(AID.PeculiarLight);
        defs.RegisterSpell(AID.TheRamsVoice);
        defs.RegisterSpell(AID.FlyingSardine);
        defs.RegisterSpell(AID.Diamondback);
        defs.RegisterSpell(AID.FireAngon);
        defs.RegisterSpell(AID.FeatherRain);
        defs.RegisterSpell(AID.Eruption);
        defs.RegisterSpell(AID.InkJet);
