...
public sealed record class ActionDefinition(ActionID ID)
{
    ...
    public delegate Vector3? TransformPositionDelegate(WorldState ws, Actor player, Actor? target, AIHints hints);
    ...
    public TransformPositionDelegate? TransformPosition; // optional ground targeting override
