...
public sealed class Definitions : Defs
{
    ...
    private void Customize(ActionDefinitions d)
    {
        ...
        d.Spell(AID.AetherialManipulation)!.AllowExecute = ActionPredicate.AllowDashToTarget;
        d.Spell(AID.BetweenTheLines)!.AllowExecute = ActionPredicate.AllowDashToPosition;

        d.Spell(AID.Triplecast)!.AllowExecute = (_, player, _, _) => player.FindStatus(SID.Triplecast) == null;
    }
}
