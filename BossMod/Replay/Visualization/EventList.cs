...
class EventList(BossModuleRegistry bmr, Replay r, Action<DateTime> scrollTo, ActionEffectParser aep, ReplayTimelineWindow.Factory timelineFactory, MediatorService mediator)
{
