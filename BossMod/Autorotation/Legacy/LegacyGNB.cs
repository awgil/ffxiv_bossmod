...
public sealed class LegacyGNB : LegacyModule
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        var res = new RotationModuleDefinition("Legacy GNB", "Old pre-refactoring module", "LazyLemo, Akechi-kun", RotationModuleQuality.WIP, BitMask.Build((int)Class.GNB), 90);
