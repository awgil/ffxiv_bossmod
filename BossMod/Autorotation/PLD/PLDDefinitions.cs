...
namespace BossMod.PLD
{
    ...
    public static class Definitions
    {
        ...
        static Definitions()
        {
            ...
            SupportedActions.OGCD(AID.FightOrFlight, 0, CDGroup.FightOrFlight, 60.0f).SetPlanningProperties(25);
            ...
            SupportedActions.OGCD(AID.Sheltron, 0, CDGroup.Sheltron, 5.0f).SetPlanningProperties(4, ActionCategory.SelfMitigation);
            SupportedActions.OGCD(AID.Sentinel, 0, CDGroup.Sentinel, 120.0f).SetPlanningProperties(15, ActionCategory.SelfMitigation);
            ...
            SupportedActions.OGCD(AID.HallowedGround, 0, CDGroup.HallowedGround, 420.0f).SetPlanningProperties(10, ActionCategory.SelfMitigation);
