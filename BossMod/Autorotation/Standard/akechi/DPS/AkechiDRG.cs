...
public sealed class AkechiDRG(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Combo).As<SingleTargetOption>("Combo", uiPriority: 200)
            ...
            .AddOption(SingleTargetOption.Force123ST, "Force123ST", "Force normal single target combo if 'Force Single-Target' option is selected")
            .AddOption(SingleTargetOption.ForceBuffsST, "ForceBuffsST", "Force single-target buff combo if 'Force Single-Target' option is selected");
        res.Define(Track.Dives).As<DivesStrategy>("Dives", uiPriority: 185)
            .AddOption(DivesStrategy.AllowMaxMelee, "AllowMaxMelee", "Allow Jump, Stardiver, & Dragonfire Dive only at max melee range (within 3y)")
            .AddOption(DivesStrategy.AllowCloseMelee, "AllowCloseMelee", "Allow Jump, Stardiver, & Dragonfire Dive only at close melee range (within 1y)")
        ...
        res.Define(Track.ElusiveJump).As<ElusiveDirection>("Elusive Jump", uiPriority: -1)
            ...
            .AddOption(ElusiveDirection.CharacterForward, "CharacterForward", "Jump into the direction forward of the character", 30, 15, ActionTargets.Self, 35)
            .AddOption(ElusiveDirection.CharacterBackward, "CharacterBackward", "Jump into the direction backward of the character (default)", 30, 15, ActionTargets.Self, 35)
            .AddOption(ElusiveDirection.CameraForward, "CameraForward", "Jump into the direction forward of the camera", 30, 15, ActionTargets.Self, 35)
            .AddOption(ElusiveDirection.CameraBackward, "CameraBackward", "Jump into the direction backward of the camera", 30, 15, ActionTargets.Self, 35)
        ...
        res.Define(Track.LanceCharge).As<BuffsStrategy>("Lance Charge", "L. Charge", uiPriority: 170)
            ...
            .AddOption(BuffsStrategy.RaidBuffsOnly, "RaidBuffsOnly", "Use Lance Charge only when in alignment with other raid buffs or when raid buffs are active", 60, 20, ActionTargets.Self, 30)
            .AddOption(BuffsStrategy.Force, "Force", "Force Lance Charge usage", 60, 20, ActionTargets.Self, 30)
            .AddOption(BuffsStrategy.ForceWeave, "ForceWeave", "Force Lance Charge usage inside the next possible weave window", 60, 20, ActionTargets.Self, 30)
        ...
        res.Define(Track.BattleLitany).As<BuffsStrategy>("BattleLitany", "B.Litany", uiPriority: 165)
            ...
            .AddOption(BuffsStrategy.RaidBuffsOnly, "RaidBuffsOnly", "Use Battle Litany only when in alignment with other raid buffs or when other raid buffs are active", 60, 20, ActionTargets.Self, 52)
            .AddOption(BuffsStrategy.Force, "Force", "Force Battle Litany usage", 180, 20, ActionTargets.Self, 52)
            .AddOption(BuffsStrategy.ForceWeave, "ForceWeave", "Force Battle Litany usage inside the next possible weave window", 180, 20, ActionTargets.Self, 52)
        ...
        res.Define(Track.LifeSurge).As<SurgeStrategy>("Life Surge", "L. Surge", uiPriority: 160)
            ...
            .AddOption(SurgeStrategy.WhenBuffed, "WhenBuffed", "Attempts to use Life Surge when under any buffs - this may be wonky to use generally; mainly for rushing use when under raidbuff(s)", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.Force, "Force", "Force Life Surge usage", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.ForceWeave, "ForceWeave", "Force Life Surge usage inside the next possible weave window", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.ForceNextOpti, "ForceNextOpti", "Force Life Surge usage in next possible optimal window", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.ForceNextOptiWeave, "ForceNextOptiWeave", "Force Life Surge optimally inside the next possible weave window", 40, 5, ActionTargets.Self, 6)
        ...
        res.Define(Track.DragonfireDive).As<CommonStrategy>("Dragonfire Dive", "D.Dive", uiPriority: 155)
            ...
            .AddOption(CommonStrategy.ForceWeave, "ForceWeave", "Force Dragonfire Dive usage inside the next possible weave window", 120, 0, ActionTargets.Hostile, 68)
            .AddOption(CommonStrategy.ForceWeaveEX, "ForceWeaveEX", "Force Dragonfire Dive usage inside the next possible weave window (Grants Dragon's Flight)", 120, 30, ActionTargets.Hostile, 92)
        ...
        res.Define(Track.Geirskogul).As<CommonStrategy>("Geirskogul", "Geirs.", uiPriority: 150)
            ...
            .AddOption(CommonStrategy.ForceWeave, "ForceWeave", "Force Geirskogul usage inside the next possible weave window", 60, 20, ActionTargets.Hostile, 70)
            .AddOption(CommonStrategy.ForceWeaveEX, "ForceWeaveEX", "Force Geirskogul usage inside the next possible weave window (Grants Life of the Dragon & Nastrond Ready)", 60, 20, ActionTargets.Hostile, 70)
        ...
        res.Define(Track.Stardiver).As<CommonStrategy>("Stardiver", "S.diver", uiPriority: 140)
            ...
            .AddOption(CommonStrategy.ForceWeave, "ForceWeave", "Force Stardiver usage inside the next possible weave window", 30, 0, ActionTargets.Hostile, 80)
            .AddOption(CommonStrategy.ForceWeaveEX, "ForceWeaveEX", "Force Stardiver usage inside the next possible weave window (Grants Starcross Ready)", 30, 0, ActionTargets.Hostile, 100)
        ...
        res.Define(Track.Jump).As<CommonStrategy>("Jump", uiPriority: 145)
            ...
            .AddOption(CommonStrategy.Force, "Force", "Force Jump usage", 30, 0, ActionTargets.Hostile, 30, 67)
            .AddOption(CommonStrategy.ForceEX, "ForceEX", "Force Jump usage (Grants Dive Ready buff)", 30, 15, ActionTargets.Hostile, 68)
            .AddOption(CommonStrategy.ForceWeave, "ForceWeave", "Force Jump usage inside the next possible weave window", 30, 0, ActionTargets.Hostile, 30, 67)
            .AddOption(CommonStrategy.ForceWeaveEX, "ForceWeaveEX", "Force Jump usage inside the next possible weave window (Grants Dive Ready buff)", 30, 15, ActionTargets.Hostile, 68)
