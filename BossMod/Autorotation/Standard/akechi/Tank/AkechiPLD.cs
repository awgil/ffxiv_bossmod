...
public sealed class AkechiPLD(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Atonement).As<AtonementStrategy>("Atones", "Atonement Combo", 155)
            ...
            .AddOption(AtonementStrategy.ForceAtonement, "ForceAtonement", "Force use of Atonement", 0, 30, ActionTargets.Hostile, 76)
            .AddOption(AtonementStrategy.ForceSupplication, "ForceSupplication", "Force use of Supplication", 0, 30, ActionTargets.Hostile, 76)
            .AddOption(AtonementStrategy.ForceSepulchre, "ForceSepulchre", "Force use of Sepulchre", 0, 0, ActionTargets.Hostile, 76)
        ...
        res.Define(Track.BladeCombo).As<BladeComboStrategy>("Blades", "Confiteor + Blade Combo", 160)
            ...
            .AddOption(BladeComboStrategy.ForceConfiteor, "ForceConfiteor", "Force use of Confiteor", 0, 0, ActionTargets.Hostile, 80)
            .AddOption(BladeComboStrategy.ForceFaith, "ForceFaith", "Force use of Blade of Faith", 0, 0, ActionTargets.Hostile, 90)
            .AddOption(BladeComboStrategy.ForceTruth, "ForceTruth", "Force use of Blade of Truth", 0, 0, ActionTargets.Hostile, 90)
            .AddOption(BladeComboStrategy.ForceValor, "ForceValor", "Force use of Blade of Valor", 0, 0, ActionTargets.Hostile, 90)
        ...
        res.Define(Track.FightOrFlight).As<BuffsStrategy>("FoF", "Fight or Flight", 170)
            ...
            .AddOption(BuffsStrategy.RaidBuffsOnly, "RaidBuffsOnly", "Use Fight or Flight only with raid buffs; will delay in attempt to align itself with raid buffs", 60, 20, ActionTargets.Self, 2)
            .AddOption(BuffsStrategy.Force, "Force", "Force Fight or Flight usage", 60, 20, ActionTargets.Self, 2)
            .AddOption(BuffsStrategy.ForceWeave, "ForceWeave", "Force Fight or Flight usage inside the next possible weave window", 60, 20, ActionTargets.Self, 2)
        ...
        res.Define(Track.Requiescat).As<BuffsStrategy>("Req.", "Requiescat", 165)
            ...
            .AddOption(BuffsStrategy.RaidBuffsOnly, "RaidBuffsOnly", "Use Requiescat / Imperator only with raid buffs; will delay in attempt to align itself with raid buffs", 180, 20, ActionTargets.Self, 68)
            .AddOption(BuffsStrategy.Force, "Force", "Force Requiescat / Imperator usage", 180, 20, ActionTargets.Self, 68)
            .AddOption(BuffsStrategy.ForceWeave, "ForceWeave", "Force Requiescat / Imperator usage inside the next possible weave window", 180, 20, ActionTargets.Self, 68)
        ...
        res.Define(Track.Holy).As<HolyStrategy>("Holy", "Holy Spirit / Circle", 150)
            ...
            .AddOption(HolyStrategy.OnlySpirit, "OnlySpirit", "Only use Holy Spirit as optimal Holy action", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(HolyStrategy.OnlyCircle, "OnlyCircle", "Only use Holy Circle as optimal Holy action", 0, 0, ActionTargets.Hostile, 72)
            .AddOption(HolyStrategy.ForceSpirit, "ForceSpirit", "Force use of Holy Spirit", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(HolyStrategy.ForceCircle, "ForceCircle", "Force use of Holy Circle", 0, 0, ActionTargets.Hostile, 72)
        ...
        res.Define(Track.Dash).As<DashStrategy>("Dash", "Intervene", 95)
            ...
            .AddOption(DashStrategy.Force1, "Force1", "Force use of Intervene; Hold one charge for manual usage", 30, 0, ActionTargets.Hostile, 66)
            .AddOption(DashStrategy.GapClose, "GapClose", "Use as gap closer if outside melee range", 30, 0, ActionTargets.None, 66)
            .AddOption(DashStrategy.GapClose1, "GapClose1", "Use as gap closer if outside melee range; Hold one charge for manual usage", 30, 0, ActionTargets.None, 66)
        ...
        res.Define(Track.Ranged).As<RangedStrategy>("Ranged", "Shield Lob / Holy Spirit", 100)
            ...
            .AddOption(RangedStrategy.OpenerRangedCast, "OpenerRangedCast", "Use Holy Spirit at the start of combat if outside melee range", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(RangedStrategy.OpenerCast, "OpenerCast", "Use Holy Spirit at the start of combat regardless of range", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(RangedStrategy.ForceCast, "ForceCast", "Force use of Holy Spirit", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(RangedStrategy.RangedCast, "RangedCast", "Use Holy Spirit as ranged choice if outside melee range", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(RangedStrategy.RangedCastStationary, "RangedCastStationary", "Use Holy Spirit as ranged choice if outside melee range and stationary", 0, 0, ActionTargets.Hostile, 64)
            .AddOption(RangedStrategy.OpenerRanged, "OpenerRanged", "Use Shield Lob at the start of combat if outside melee range", 0, 0, ActionTargets.Hostile, 15)
