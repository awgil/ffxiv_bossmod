...
internal static class AIExt
{
    ...
    {
        return def.Define(track).As<AbilityUse>(name, display, uiPriority, renderer: typeof(CheckboxRenderer)).AddOption(AbilityUse.Enabled).AddOption(AbilityUse.Disabled);
    }
