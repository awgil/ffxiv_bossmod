...
public class HealerAI(RotationModuleManager manager, Actor player) : AIBase(manager, player)
{
    ...
    {
        var def = new RotationModuleDefinition("Healer AI", "Auto-healer", "AI|Role", "xan", RotationModuleQuality.WIP, BitMask.Build(Class.CNJ, Class.WHM, Class.SCH, Class.SGE, Class.AST), 100);
