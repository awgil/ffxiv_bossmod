...
public sealed class MNK(RotationModuleManager manager, Actor player) : Attackxan<AID, TraitID>(manager, player, PotionType.Strength)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        def.Define(Track.FiresReply).As<FRStrategy>("FiresReply", uiPriority: 95)
            .AddOption(FRStrategy.Automatic, minLevel: 100)
            .AddOption(FRStrategy.Ranged, minLevel: 100)
            .AddOption(FRStrategy.Force, minLevel: 100)
            .AddOption(FRStrategy.Delay, minLevel: 100)
        ...
        def.Define(Track.WindsReply).As<WRStrategy>("WindsReply", uiPriority: 93)
            .AddOption(WRStrategy.Automatic, minLevel: 96)
            .AddOption(WRStrategy.Force, minLevel: 96)
            .AddOption(WRStrategy.PreDowntime, minLevel: 96)
            .AddAssociatedActions(AID.WindsReply);

        // PB-related settings
        def.Define(Track.PB).As<PBStrategy>("PB", uiPriority: 89)
            .AddOption(PBStrategy.Automatic, minLevel: 50)
            .AddOption(PBStrategy.ForceOpo, minLevel: 50)
            .AddOption(PBStrategy.Force, minLevel: 50)
            .AddOption(PBStrategy.Delay, minLevel: 50)
            .AddOption(PBStrategy.DowntimeSolar, minLevel: 60, effect: 39)
            .AddOption(PBStrategy.DowntimeLunar, minLevel: 60, effect: 39)
            .AddAssociatedActions(AID.PerfectBalance);
        def.Define(Track.Nadi).As<NadiStrategy>("Nadi", uiPriority: 88)
            .AddOption(NadiStrategy.Automatic, minLevel: 60)
        ...
        def.Define(Track.Blitz).As<BlitzStrategy>("Blitz", uiPriority: 87)
            .AddOption(BlitzStrategy.Automatic, minLevel: 60)
            .AddOption(BlitzStrategy.RoF, minLevel: 60)
            .AddOption(BlitzStrategy.Multi, minLevel: 60)
            .AddOption(BlitzStrategy.MultiRoF, minLevel: 60)
            .AddOption(BlitzStrategy.Delay, minLevel: 60)
        ...
        def.Define(Track.Meditation).As<MeditationStrategy>("Meditate", uiPriority: 77)
            .AddOption(MeditationStrategy.Safe)
            .AddOption(MeditationStrategy.Greedy)
            .AddOption(MeditationStrategy.Force)
            .AddOption(MeditationStrategy.Delay)
            .AddAssociatedActions(AID.SteeledMeditation);

        // other utils
        def.Define(Track.TC).As<TCStrategy>("TC", uiPriority: 69)
            .AddOption(TCStrategy.None, minLevel: 35)
            .AddOption(TCStrategy.GapClose, minLevel: 35, supportedTargets: ActionTargets.Party | ActionTargets.Hostile)
            .AddAssociatedActions(AID.Thunderclap);

        def.Define(Track.Potion).As<PotionStrategy>("Pot", uiPriority: 59)
            .AddOption(PotionStrategy.Manual)
            .AddOption(PotionStrategy.PreBuffs)
            .AddOption(PotionStrategy.Now)
            .AddAssociatedAction(ActionDefinitions.IDPotionStr);

        def.Define(Track.Engage).As<EngageStrategy>("Engage", uiPriority: 49)
            .AddOption(EngageStrategy.TC)
            .AddOption(EngageStrategy.Sprint)
            .AddOption(EngageStrategy.FacepullDK)
            .AddOption(EngageStrategy.FacepullDemo);
