...
public sealed class RPR(RotationModuleManager manager, Actor player) : Attackxan<AID, TraitID>(manager, player, PotionType.Strength)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        def.Define(Track.Harpe).As<HarpeStrategy>("Harpe")
            .AddOption(HarpeStrategy.Automatic, "Automatic", "Use out of melee range if Enhanced Harpe is active")
            .AddOption(HarpeStrategy.Forbid, "Forbid", "Don't use")
            .AddOption(HarpeStrategy.Ranged, "Ranged", "Use out of melee range");
