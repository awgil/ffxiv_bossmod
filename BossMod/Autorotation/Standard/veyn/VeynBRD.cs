...
public sealed class VeynBRD(RotationModuleManager manager, Actor player) : RotationModule(manager, player)
{
    ...
    {
        var res = new RotationModuleDefinition("Veyn BRD", "Bard Rotation Module", "Standard Rotations|veyn", "veyn", RotationModuleQuality.Basic, BitMask.Build((int)Class.BRD, (int)Class.ARC), 100);
