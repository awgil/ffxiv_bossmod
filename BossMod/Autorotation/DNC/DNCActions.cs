...
namespace BossMod.DNC
{
    class Actions : CommonActions
    {
        ...
        protected override NextAction CalculateAutomaticOGCD(float deadline)
        {
            ...
            if (_state.Unlocked(AID.ClosedPosition)
        ...
        private void UpdatePlayerState()
        {
            ...
            _state.Gauge = Service.JobGauges.Get<DNCGauge>();
        ...
        private bool FindDancePartner([NotNullWhen(true)] out Actor? actor)
        {
            ...
            var target = Autorot.WorldState.Party.WithoutSlot().Exclude(Player).MaxBy(p => p.Class switch
            {
                Class.SAM => 1.00,
                Class.NIN => 0.99,
                Class.MNK => 0.88,
