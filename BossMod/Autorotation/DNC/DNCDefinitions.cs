...
namespace BossMod.DNC
{
    ...
    public static class Definitions
    {
        ...
        static Definitions()
        {
            ...
            SupportedActions.OGCD(AID.ShieldSamba, 0, CDGroup.ShieldSamba, 120.0f);
            ...
            SupportedActions.OGCD(AID.Flourish, 0, CDGroup.Flourish, 60.0f);
            SupportedActions.GCD(AID.SaberDance, 25);
            SupportedActions.OGCD(AID.ImprovisedFinish, 0, CDGroup.ImprovisedFinish, 1.5f);
