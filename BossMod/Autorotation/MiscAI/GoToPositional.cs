...
public sealed class GoToPositional(RotationModuleManager manager, Actor player) : RotationModule(manager, player)
{
    ...
    {
        RotationModuleDefinition def = new("Go to specified positional", "Module for use with other rotation plugins", "AI|Misc", "erdelf", RotationModuleQuality.Basic, new(~0ul), 1000);
