...
public sealed class AutoPull(RotationModuleManager manager, Actor player) : RotationModule(manager, player)
{
    ...
    {
        var def = new RotationModuleDefinition("Auto-Engage", "Automatically attack passive mobs in certain circumstances", "AI|Auto", "xan", RotationModuleQuality.Basic, new(~0ul), 1000, Order: RotationModuleOrder.HighLevel, CanUseWhileRoleplaying: true);
