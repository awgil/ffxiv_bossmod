...
namespace BossMod.WAR
{
    ...
    public static class Definitions
    {
        ...
        static Definitions()
        {
            ...
            SupportedActions.OGCD(AID.Berserk, 0, CDGroup.Berserk, 60.0f).SetPlanningProperties(15);
            SupportedActions.OGCD(AID.InnerRelease, 0, CDGroup.InnerRelease, 60.0f).SetPlanningProperties(15);
            SupportedActions.OGCD(AID.Rampart, 0, CDGroup.Rampart, 90.0f).SetPlanningProperties(20, ActionCategory.SelfMitigation);
            SupportedActions.OGCD(AID.Vengeance, 0, CDGroup.Vengeance, 120.0f).SetPlanningProperties(15, ActionCategory.SelfMitigation);
            SupportedActions.OGCD(AID.ThrillOfBattle, 0, CDGroup.ThrillOfBattle, 90.0f).SetPlanningProperties(10, ActionCategory.SelfMitigation);
            SupportedActions.OGCD(AID.Holmgang, 6, CDGroup.Holmgang, 240.0f).SetPlanningProperties(10, ActionCategory.SelfMitigation);
