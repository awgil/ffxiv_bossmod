...
public abstract class RoleTankUtility(RotationModuleManager manager, Actor player) : GenericUtility(manager, player)
{
    ...
    protected static void DefineShared(ActionDefinitions defs, RotationModuleDefinition def, ActionID lb3, ActionID stanceApply, ActionID stanceRemove)
    {
        ...
        DefineSimpleConfig(defs, def, SharedTrack.Rampart, "Rampart", "", 500, ClassShared.AID.Rampart, 20);
        DefineSimpleConfig(defs, def, SharedTrack.LowBlow, "LowBlow", "Stun", -100, ClassShared.AID.LowBlow, 5);
        DefineSimpleConfig(defs, def, SharedTrack.Provoke, "Provoke", "", 200, ClassShared.AID.Provoke);
        DefineSimpleConfig(defs, def, SharedTrack.Interject, "Interject", "Interrupt", -50, ClassShared.AID.Interject);
        ...
        DefineSimpleConfig(defs, def, SharedTrack.Shirk, "Shirk", "", 150, ClassShared.AID.Shirk);
