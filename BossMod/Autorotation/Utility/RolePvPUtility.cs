...
public sealed class RolePvPUtility(RotationModuleManager manager, Actor player) : RotationModule(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Guard).As<GuardStrategy>("Guard", uiPriority: 150)
            ...
            .AddOption(GuardStrategy.Two, "Two", "Automatically use Guard when HP is not full and two or more targets are targeting you")
            .AddOption(GuardStrategy.Three, "Three", "Automatically use Guard when HP is not full and three or more targets are targeting you")
            .AddOption(GuardStrategy.Four, "Four", "Automatically use Guard when HP is not full and four or more targets are targeting you")
