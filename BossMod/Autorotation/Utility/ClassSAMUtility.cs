...
public sealed class ClassSAMUtility(RotationModuleManager manager, Actor player) : RoleMeleeUtility(manager, player)
{
    ...
    {
        var res = new RotationModuleDefinition("Utility: SAM", "Planner support for utility actions", "xan, Akechi", RotationModuleQuality.Excellent, BitMask.Build((int)Class.SAM), 100);
