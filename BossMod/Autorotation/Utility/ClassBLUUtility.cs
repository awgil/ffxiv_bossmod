...
public sealed class ClassBLUUtility(RotationModuleManager manager, Actor player) : RoleCasterUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition(ActionDefinitions defs)
    {
        ...
        DefineSimpleConfig(defs, res, Track.Bristle, "Bristle", "Bristle", 100, BLU.AID.Bristle, 30);
        DefineSimpleConfig(defs, res, Track.WhiteWind, "White Wind", "W.Wind", 100, BLU.AID.WhiteWind);
        DefineSimpleConfig(defs, res, Track.IceSpikes, "Ice Spikes", "I.Spikes", 50, BLU.AID.IceSpikes, 15);
        DefineSimpleConfig(defs, res, Track.OffGuard, "Off Guard", "OffG.", 25, BLU.AID.OffGuard, 15);
        DefineSimpleConfig(defs, res, Track.Transfusion, "Transfusion", "Transf.", 10, BLU.AID.Transfusion);
        DefineSimpleConfig(defs, res, Track.Diamondback, "Diamondback", "D.back", 100, BLU.AID.Diamondback, 10);
        DefineSimpleConfig(defs, res, Track.MightyGuard, "Mighty Guard", "MightyG.", 10, BLU.AID.MightyGuard);
        DefineSimpleConfig(defs, res, Track.ToadOil, "Toad Oil", "T.Oil", 10, BLU.AID.ToadOil, 180);
        DefineSimpleConfig(defs, res, Track.MoonFlute, "Moon Flute", "MoonFlute", 100, BLU.AID.MoonFlute, 15);
        DefineSimpleConfig(defs, res, Track.PeculiarLight, "Peculiar Light", "P.Light", 25, BLU.AID.PeculiarLight, 15);
        DefineSimpleConfig(defs, res, Track.VeilOfTheWhorl, "Veil Of The Whorl", "V.Whorl", 100, BLU.AID.VeilOfTheWhorl, 30);
        DefineSimpleConfig(defs, res, Track.EerieSoundwave, "Eerie Soundwave", "Soundwave", 100, BLU.AID.EerieSoundwave);
        DefineSimpleConfig(defs, res, Track.PomCure, "Pom Cure", "PomCure", 100, BLU.AID.PomCure);
        DefineSimpleConfig(defs, res, Track.Gobskin, "Gobskin", "Gobskin", 100, BLU.AID.Gobskin, 30);
        DefineSimpleConfig(defs, res, Track.Avail, "Avail", "Avail", 100, BLU.AID.Avail, 12);
        DefineSimpleConfig(defs, res, Track.FrogLegs, "Frog Legs", "F.Legs", 10, BLU.AID.FrogLegs);
        DefineSimpleConfig(defs, res, Track.Whistle, "Whistle", "Whistle", 100, BLU.AID.Whistle, 30);
        DefineSimpleConfig(defs, res, Track.Cactguard, "Cactguard", "CactG.", 100, BLU.AID.Cactguard, 6);
        DefineSimpleConfig(defs, res, Track.AngelWhisper, "Angel Whisper", "A.Whisper", 100, BLU.AID.AngelWhisper);
        DefineSimpleConfig(defs, res, Track.Exuviation, "Exuviation", "Exuvi", 100, BLU.AID.Exuviation);
        DefineSimpleConfig(defs, res, Track.ColdFog, "Cold Fog", "C.Fog", 50, BLU.AID.ColdFog, 5);
        DefineSimpleConfig(defs, res, Track.Stotram, "Stotram (Heal)", "Stotram", 100, BLU.AID.StotramHeal);
        DefineSimpleConfig(defs, res, Track.AngelsSnack, "Angels Snack", "A.Snack", 100, BLU.AID.AngelsSnack, 15);
        DefineSimpleConfig(defs, res, Track.ChelonianGate, "Chelonian Gate", "C.Gate", 100, BLU.AID.ChelonianGate, 10);
        DefineSimpleConfig(defs, res, Track.BasicInstinct, "Basic Instinct", "Instinct", 10, BLU.AID.BasicInstinct);
        DefineSimpleConfig(defs, res, Track.DragonForce, "Dragon Force", "D.Force", 100, BLU.AID.DragonForce, 15);
        DefineSimpleConfig(defs, res, Track.Schiltron, "Schiltron", "Schilt", 100, BLU.AID.Schiltron, 15);
        DefineSimpleConfig(defs, res, Track.Rehydration, "Rehydration", "Rehyd.", 100, BLU.AID.Rehydration);
        DefineSimpleConfig(defs, res, Track.ForceField, "Force Field", "F.Field", 100, BLU.AID.ForceField, 10);
