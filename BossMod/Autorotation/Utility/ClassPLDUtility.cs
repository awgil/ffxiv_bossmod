...
public sealed class ClassPLDUtility(RotationModuleManager manager, Actor player) : RoleTankUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Sheltron).As<ShelOption>("Sheltron", "Shel", 350) //Sheltron defintion for CD plans
        ...
        res.Define(Track.Sentinel).As<SentOption>("Sentinel", "Sent", 550) //Sentinel defintion for CD plans
        ...
        DefineSimpleConfig(res, Track.Cover, "Cover", "", 320, PLD.AID.Cover, 12); //Cover defintion for CD plan 
        DefineSimpleConfig(res, Track.Bulwark, "Bulwark", "Bul", 450, PLD.AID.Bulwark, 10); //Bulwark deifnition
        DefineSimpleConfig(res, Track.DivineVeil, "DivineVeil", "Veil", 220, PLD.AID.DivineVeil, 30); //DivineVeil defintion for CD plan
        DefineSimpleConfig(res, Track.PassageOfArms, "PassageOfArms", "Arms", 470, PLD.AID.PassageOfArms, 3); //PassageOfArms defintion for CD plan
        DefineSimpleConfig(res, Track.HallowedGround, "HallowedGround", "Inv", 400, PLD.AID.HallowedGround, 10); //HallowedGround defintion for CD plan
