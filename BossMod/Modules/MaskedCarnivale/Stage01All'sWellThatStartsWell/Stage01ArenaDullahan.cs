namespace BossMod.MaskedCarnivale.Stage01.Act1.ArenaDullahan
{
...
class Stage01DullahanStates : StateMachineBuilder
    {
        public Stage01DullahanStates(BossModule module) : base(module)
        {
            TrivialPhase()
...
public class Stage01Dullahan : BossModule
    {
        public Stage01Dullahan(WorldState ws, Actor primary) : base(ws, primary, new ArenaBoundsCircle(new(100, 100), 25))
        {
