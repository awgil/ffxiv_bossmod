...
class FireAndLightningBoss(BossModule module) : Components.SelfTargetedAOEs(module, AID.FireAndLightningBoss, new AOEShapeRect(54.3f, 10));
class FireAndLightningAdd(BossModule module) : Components.SelfTargetedAOEs(module, AID.FireAndLightningAdd, new AOEShapeRect(54.75f, 10));
