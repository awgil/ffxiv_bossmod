...
class ArmOfPurgatory(BossModule module) : Components.StandardAOEs(module, AID.ArmOfPurgatory, 24f);
class VoidFireIII(BossModule module) : Components.StandardAOEs(module, AID.VoidFireIII, 10f);
class DarkMist(BossModule module) : Components.StandardAOEs(module, AID.DarkMist, 20.0f);
