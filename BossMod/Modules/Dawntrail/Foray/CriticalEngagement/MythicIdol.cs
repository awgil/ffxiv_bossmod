...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.CFC, GroupID = 1018, NameID = 13726)]
public class MythicIdol(WorldState ws, Actor primary) : CEModule(ws, primary, new(-800, 245), new ArenaBoundsCircle(24.5f));
