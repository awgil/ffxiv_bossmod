...
public abstract class CEModule(WorldState ws, Actor primary, WPos center, ArenaBounds bounds) : BossModule(ws, primary, center, bounds)
{
    ...
    protected sealed override bool CheckPull() => CheckPullCE() && WorldState.Party.Player()?.FindStatus(1778) != null;

    protected virtual bool CheckPullCE() => PrimaryActor.IsTargetable && PrimaryActor.InCombat;
