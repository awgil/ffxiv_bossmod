namespace BossMod.Dawntrail.Foray.ForkedTower.FTB2DeadStars;
...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.CFC, GroupID = 1018, NameID = 13738, PrimaryActorOID = (uint)OID.Triton, PlanLevel = 100)]
public class FTB2DeadStars(WorldState ws, Actor primary) : BossModule(ws, primary, new(-800, 360), new ArenaBoundsCircle(35))
{
