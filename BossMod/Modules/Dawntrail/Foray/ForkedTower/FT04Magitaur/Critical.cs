...
class CriticalAxeblow(BossModule module) : Components.GenericAOEs(module)
{
    ...
    public override IEnumerable<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
        ...
        {
            yield return new(new AOEShapeCircle(20), Arena.Center, Activation: _activation);
...
class CriticalLanceblow(BossModule module) : Components.GenericAOEs(module)
{
    ...
    public override IEnumerable<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
        if (_activation != default)
        {
            yield return new AOEInstance(new AOEShapeDonut(10, 32), Arena.Center, Activation: _activation);
            yield return new AOEInstance(new AOEShapeRect(10, 10, 10), Arena.Center + new WDir(0, 14.5f), 45.Degrees(), _activation);
            yield return new AOEInstance(new AOEShapeRect(10, 10, 10), Arena.Center + new WDir(0, 14.5f).Rotate(120.Degrees()), 165.Degrees(), _activation);
            yield return new AOEInstance(new AOEShapeRect(10, 10, 10), Arena.Center + new WDir(0, 14.5f).Rotate(-120.Degrees()), -75.Degrees(), _activation);
        }
    }
