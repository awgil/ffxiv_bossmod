namespace BossMod.Dawntrail.Foray.ForkedTower.FT13Necrophobia;
...
public class FT13Necrophobia(WorldState ws, Actor primary) : BossModule(ws, primary, new(100, 800), new ArenaBoundsCircle(24))
{
