...
public enum AID : uint
{
    ...
    _Ability_SynchronizedStrike1 = 44438, // Helper->self, 5.0s cast, range 60 width 10 rect
    _Ability_SynchronizedSmite = 44443, // 4941->self, 5.0s cast, range 60 width 32 rect
    _Ability_SynchronizedSmite1 = 44444, // 4942->self, 5.0s cast, range 60 width 32 rect
    ...
    _Ability_Wringer = 44434, // Boss->self, 5.0s cast, range 14 circle
    _Ability_DeadWringer = 44439, // 4941->self, 5.0s cast, range 14-30 donut
    _Ability_DeadWringer1 = 44440, // 4942->self, 5.0s cast, single-target
    _Ability_StrikingLeft = 44436, // Boss->self, 5.0s cast, range 10 circle
    _Ability_SmitingLeft = 44442, // 4942->self, 5.0s cast, range 30 circle
    _Ability_SynchronizedStrike2 = 44464, // Helper->self, 3.0s cast, range 60 width 10 rect
    _Ability_StrikingRight = 44462, // Helper->self, 3.0s cast, range 10 circle
    ...
    _Ability_StrikingRight1 = 44451, // Boss->self, 2.0s cast, range 10 circle
    _Ability_SmitingRight = 44457, // 4941->self, 2.0s cast, range 30 circle
    ...
    _Ability_Wringer1 = 44461, // Helper->self, 3.0s cast, range 14 circle
    ...
    _Ability_Wringer2 = 44450, // Boss->self, 2.0s cast, range 14 circle
    _Ability_SmitingRight1 = 44441, // 4941->self, 5.0s cast, range 30 circle
    ...
    _Ability_DeadWringer3 = 44455, // 4941->self, 2.0s cast, range ?-30 donut
    ...
    _Ability_StrikingLeft1 = 44463, // Helper->self, 3.0s cast, range 10 circle
    _Ability_StrikingLeft2 = 44452, // Boss->self, 2.0s cast, range 10 circle
    _Ability_SmitingLeft1 = 44458, // 4942->self, 2.0s cast, range 30 circle
    ...
    _Ability_StrikingRight2 = 44435, // Boss->self, 5.0s cast, range 10 circle
