...
class Venom(BossModule module) : Components.SelfTargetedAOEs(module, AID.Venom, new AOEShapeCone(30, 60.Degrees()));
class AbsoluteTerror(BossModule module) : Components.SelfTargetedAOEs(module, AID.AbsoluteTerrorAOE, new AOEShapeRect(70, 10));
class WingedTerror(BossModule module) : Components.SelfTargetedAOEs(module, AID.WingedTerrorAOE, new AOEShapeRect(70, 12.5f));
