...
public enum OID : uint
{
    ...
    _Gen_SweetShot = 0x47A2, // R1.500, x0 (spawn during fight)
}
...
public enum AID : uint
{
    ...
    _Weaponskill_SingleStyle = 39485, // Boss->self, 6.0+0.9s cast, single-target
    _Weaponskill_Rush = 42630, // _Gen_SweetShot->location, 1.0s cast, width 7 rect charge
    _Weaponskill_DoubleStyle5 = 37834, // Boss->self, 12.0+0.9s cast, single-target
    _Weaponskill_Sugarscape1 = 42595, // Boss->self, 1.0+7.0s cast, single-target
    _Weaponskill_DoubleStyle9 = 42631, // Boss->self, 6.0+0.9s cast, single-target
    _Spell_TasteOfFire = 42632, // Helper->players, no cast, range 6 circle
    _Weaponskill_Layer2 = 42648, // Boss->self, 1.0+6.0s cast, single-target
    _Spell_ = 42652, // Helper->self, no cast, single-target
    _Spell_TasteOfThunder = 42653, // Helper->location, 3.0s cast, range 3 circle
    _Spell_Highlightning = 42651, // 47A3->self, 2.0s cast, range 21 circle
    _Spell_LightningBolt = 42650, // Helper->location, 3.0s cast, range 4 circle
    _Spell_LightningStorm = 42654, // Helper->players, no cast, range 8 circle
    _Spell_LevinDrop = 42655, // Helper->self, no cast, range 60 circle
    _Weaponskill_DoubleStyle10 = 42633, // Boss->self, 6.0+0.9s cast, single-target
    _Spell_TasteOfThunder1 = 42634, // Helper->players, no cast, range 6 circle
    _Spell_LevinMerengue = 42656, // Helper->self, no cast, range 60 circle
    _Spell_PuddingParty = 42605, // Boss->self, 4.0+1.0s cast, single-target
    _Spell_PuddingParty1 = 42681, // Helper->players, no cast, range 6 circle
    _Weaponskill_Layer3 = 42649, // Boss->self, 1.0+6.0s cast, single-target
    _Spell_MousseDrip = 42679, // Boss->self, 5.0s cast, single-target
    _Spell_MousseDrip1 = 42680, // Helper->players, no cast, range 5 circle
    _Spell_Moussacre = 42682, // Boss->self, 4.0+1.0s cast, single-target
    _Spell_Moussacre1 = 42683, // Helper->self, no cast, range 60 ?-degree cone
    _Spell_Explosion = 42659, // Helper->self, no cast, range 3 circle
    _Spell_UnmitigatedExplosion = 42660, // Helper->self, no cast, range 100 circle
    _Weaponskill_ArtisticAnarchy = 42685, // Boss->self, 8.0+0.9s cast, single-target
    _Weaponskill_Rush1 = 42690, // _Gen_SweetShot->location, 3.0s cast, width 7 rect charge
    _Weaponskill_Burst2 = 42687, // _Gen_HeavenBomb->location, 3.0s cast, range 15 circle
    _Weaponskill_BadBreath1 = 42688, // _Gen_MouthwateringMorbol->self, 3.0s cast, range 50 100-degree cone
    _Weaponskill_Burst3 = 42686, // _Gen_PaintBomb->self, 3.0s cast, range 15 circle
    _Spell_DarkMist1 = 42689, // _Gen_CandiedSuccubus->self, 3.0s cast, range 30 circle
}
