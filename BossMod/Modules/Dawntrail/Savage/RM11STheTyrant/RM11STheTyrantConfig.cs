...
[ConfigDisplay(Parent = typeof(DawntrailConfig), Order = -2)]
public class RM11STheTyrantConfig : ConfigNode
{
    ...
    [GroupPreset("One melee per tower; flex order H -> R", [0, 1, 3, 4, 2, 7, 5, 6])]
    [GroupPreset("One melee per tower; flex order R -> H", [0, 1, 5, 6, 2, 7, 3, 4])]
