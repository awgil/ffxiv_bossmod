...
public enum AID : uint
{
    ...
    W2SnapBoss1 = 42794, // Boss->self, 5.0s cast, range 20 width 40 rect
    ...
    W3SnapBoss4 = 42801, // Boss->self, 5.0s cast, range 20 width 40 rect
    ...
    W4SnapBoss1 = 42814, // Boss->self, 5.0s cast, range 20 width 40 rect
    ...
    W2SnapBoss6 = 42792, // Boss->self, 5.0s cast, range 20 width 40 rect
    W3SnapBoss7 = 42804, // Boss->self, 5.0s cast, range 20 width 40 rect
    FreakOut1 = 42854, // Helper->player, no cast, single-target
    FreakOut2 = 42855, // Helper->player, no cast, single-target
    W2SnapBoss7 = 42795, // Boss->self, 5.0s cast, range 20 width 40 rect
    W4SnapBoss6 = 42810, // Boss->self, 5.0s cast, range 20 width 40 rect
    W2SnapBoss3 = 42797, // Boss->self, 5.0s cast, range 20 width 40 rect
    W2SnapBoss2 = 42796, // Boss->self, 5.0s cast, range 20 width 40 rect
    ...
    W3SnapBoss2 = 42205, // Boss->self, 5.0s cast, range 20 width 40 rect
    W3SnapBoss3 = 42802, // Boss->self, 5.0s cast, range 20 width 40 rect
    W4SnapBoss4 = 42809, // Boss->self, 5.0s cast, range 20 width 40 rect
    ...
    W4SnapBoss3 = 42813, // Boss->self, 5.0s cast, range 20 width 40 rect
    W4SnapBoss2 = 42812, // Boss->self, 5.0s cast, range 20 width 40 rect
    W4SnapBoss7 = 42208, // Boss->self, 5.0s cast, range 20 width 40 rect
    W2SnapBoss4 = 42793, // Boss->self, 5.0s cast, range 20 width 40 rect
    W2SnapBoss5 = 42204, // Boss->self, 5.0s cast, range 20 width 40 rect
    ...
    W4SnapBoss5 = 42811, // Boss->self, 5.0s cast, range 20 width 40 rect
    W3SnapBoss5 = 42803, // Boss->self, 5.0s cast, range 20 width 40 rect
