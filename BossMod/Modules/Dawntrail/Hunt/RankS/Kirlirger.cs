...
class FullmoonFury(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.FullmoonFury), new AOEShapeCircle(20));
class FullmoonFuryHonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.FullmoonFuryHonor), new AOEShapeCircle(20));
class FullmoonFuryDishonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.FullmoonFuryDishonor), new AOEShapeDonut(10, 40));
class DiscordantMoon(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.DiscordantMoon), new AOEShapeDonut(10, 40));
class DiscordantMoonHonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.DiscordantMoonHonor), new AOEShapeDonut(10, 40));
class DiscordantMoonDishonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.DiscordantMoonDishonor), new AOEShapeCircle(20));
class FightersFlourish(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.FightersFlourish), new AOEShapeCone(40, 135.Degrees()));
class FightersFlourishHonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.FightersFlourishHonor), new AOEShapeCone(40, 135.Degrees()));
class FightersFlourishDishonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.FightersFlourishDishonor), new AOEShapeCone(40, 135.Degrees()));
class DiscordantFlourish(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.DiscordantFlourish), new AOEShapeCone(40, 135.Degrees()));
class DiscordantFlourishHonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.DiscordantFlourishHonor), new AOEShapeCone(40, 135.Degrees()));
class DiscordantFlourishDishonor(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.DiscordantFlourishDishonor), new AOEShapeCone(40, 135.Degrees()));
class EnervatingGloom(BossModule module) : Components.StackWithCastTargets(module, ActionID.MakeSpell(AID.EnervatingGloom), 6, 4);
