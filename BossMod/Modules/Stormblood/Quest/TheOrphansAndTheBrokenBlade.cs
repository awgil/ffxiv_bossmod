...
class SpiralHell(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.SpiralHell), new AOEShapeRect(40, 2));
...
class ShadowOfDeath(BossModule module) : Components.LocationTargetedAOEs(module, ActionID.MakeSpell(AID.ShadowOfDeath1), 5);
