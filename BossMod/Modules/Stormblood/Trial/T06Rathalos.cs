...
namespace BossMod.Stormblood.Trial.T06Rathalos;

public enum OID : uint
{
    Boss = 0x2129, // R5.460, x1
    WyvernsTail = 0x23C0, // R3.900, x1, Part type
    SteppeSheep = 0x212B, // R0.700, x0 (spawn during fight)
    SteppeYamaa = 0x212C, // R1.920, x0 (spawn during fight)
    SteppeYamaa1 = 0x212D, // R1.920, x0 (spawn during fight)
    SteppeCoeurl = 0x212E, // R3.150, x0 (spawn during fight)
    Garula = 0x212A, // R4.000, x0 (spawn during fight)
    Fireball = 0x1E9927
}

public enum AID : uint
{
    // comments may be inaccurate, copied from ex
    _Weaponskill_Roar = 11460, // Boss->self, no cast, range 50+R circle
    _Weaponskill_Mangle = 10346, // Boss->self, 2.5s cast, range 10 ?-degree cone
    _Weaponskill_Mangle1 = 11449, // 18D6->self, no cast, range 10 ?-degree cone
    _Weaponskill_TailSmash = 10347, // 18D6->self, no cast, range 11 ?-degree cone
    _Weaponskill_Rush = 10349, // Boss->location, 2.0s cast, width 9 rect charge
    _Weaponskill_Rush1 = 11452, // 18D6->location, no cast, width 9 rect charge
    _Weaponskill_TailSwing = 10348, // Boss->self, no cast, range 11 ?-degree cone
    _Weaponskill_TailSwing1 = 11452, // 18D6->self, no cast, range 11 ?-degree cone
    ...
    _Weaponskill_Roar1 = 10356, // Boss->self, no cast, range 50+R circle
    _Weaponskill_Rush2 = 10367, // 2130->Boss, 2.0s cast, width 8 rect charge
    //_Ability_Lanolin = 10328, // 2133->self, 2.5s cast, single-target
    _Weaponskill_KingOfTheSkies = 10357, // Boss->location, no cast, range 50 circle
    _Weaponskill_KingOfTheSkies1 = 11546, // 18D6->location, no cast, range 50 circle
    _Weaponskill_SweepingFlames = 10361, // Boss->self, no cast, range 11 ?-degree cone
    _Weaponskill_SweepingFlames1 = 11457, // 18D6->self, no cast, range 11 ?-degree cone
    _Weaponskill_Mangle2 = 10362, // Boss->self, 0.7s cast, range 9 ?-degree cone
    _Weaponskill_Mangle3 = 11458, // 18D6->self, no cast, range 9 ?-degree cone
    _Weaponskill_Fireball = 10358, // Boss->player, 5.0s cast, range 5 circle
    _Weaponskill_Fireball1 = 11450, // 18D6->player, no cast, range 5 circle
    ...
    _Weaponskill_Rush3 = 10360, // Boss->location, 1.0s cast, width 10 rect charge
    _Weaponskill_Rush4 = 11456, // 18D6->location, no cast, width 9 rect charge
...
[ModuleInfo(BossModuleInfo.Maturity.Contributed, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 474, NameID = 7221)]
