...
public enum AID : uint
{
    ...
    AutoAttack2 = 872, // BonusAdd_AltarMatanga,Mandragoras->player, no cast, single-target
...
public class TheOlderOne(WorldState ws, Actor primary) : BossModule(ws, primary, new ArenaBoundsCircle(new(100, 100), 19))
{
