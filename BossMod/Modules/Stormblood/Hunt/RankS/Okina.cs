...
class Hydrocannon(BossModule module) : Components.SelfTargetedAOEs(module, AID.Hydrocannon, new AOEShapeRect(30, 3));
class ElectricWhorl(BossModule module) : Components.SelfTargetedAOEs(module, AID.ElectricWhorl, new AOEShapeDonut(8, 60));
class Expulsion(BossModule module) : Components.SelfTargetedAOEs(module, AID.Expulsion, new AOEShapeCircle(14));
...
class ElectricSwipe(BossModule module) : Components.SelfTargetedAOEs(module, AID.ElectricSwipe, new AOEShapeCone(25, 30.Degrees()));
