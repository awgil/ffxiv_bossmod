...
class BloodyCaress(BossModule module) : Components.StandardAOEs(module, AID.BloodyCaress, new AOEShapeCone(8, 45.Degrees()));
class AcidRain(BossModule module) : Components.StandardAOEs(module, AID.AcidRain2, 6);
class SweetScent(BossModule module) : Components.BaitAwayIcon(module, new AOEShapeCone(45, 45.Degrees()), 46, AID.FloralTrap);
class FlowerDevour(BossModule module) : Components.StandardAOEs(module, AID.FlowerDevour, new AOEShapeCircle(8));
...
public class D021Raskovnik(ModuleInitializer init) : BossModule(init, new(-127, 168), new ArenaBoundsCircle(23f));
