...
// Constructor so we can build arena
    ...
    private static (WPos center, ArenaBoundsCustom arena) BuildArena()
    {
        ...
        [
            ...
            new Circle(new WPos(-18.4f, -4.9f), 1f), new Rectangle(new WPos(-19.3f, -5.2f), 1f, 1f, -106.5f.Degrees()),
            new Circle(new WPos(-18.8f, -2.6f), 1f), new Rectangle(new WPos(-19.8f, -2.8f), 1f, 1f, -90.5f.Degrees()),
