...
public class T02ADS(ModuleArgs init) : BossModule(init, new(0, 77), new ArenaBoundsRect(18, 13));
...
public class T02QuarantineNode(ModuleArgs init) : BossModule(init, new(0, 112), new ArenaBoundsRect(14, 13))
{
...
public class T02AttackNode(ModuleArgs init) : BossModule(init, new(-44, 94), new ArenaBoundsSquare(17))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies(OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
public class T02SanitaryNode(ModuleArgs init) : BossModule(init, new(-43, 52), new ArenaBoundsRect(18, 15))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies(OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
public class T02MonitoringNode(ModuleArgs init) : BossModule(init, new(0, 39), new ArenaBoundsRect(17, 15))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies(OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
public class T02DefenseNode(ModuleArgs init) : BossModule(init, new(46, 52), new ArenaBoundsRect(17, 14))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies(OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
public class T02DisposalNode(ModuleArgs init) : BossModule(init, new(41, 94), new ArenaBoundsRect(14, 20))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies(OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
