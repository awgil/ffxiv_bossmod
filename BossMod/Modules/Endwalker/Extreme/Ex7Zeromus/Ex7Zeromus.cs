...
class AbyssalEchoes(BossModule module) : Components.SelfTargetedAOEs(module, AID.AbyssalEchoes, new AOEShapeCircle(12), 5);
class BigBangPuddle(BossModule module) : Components.LocationTargetedAOEs(module, AID.BigBangAOE, 5);
class BigBangSpread(BossModule module) : Components.SpreadFromCastTargets(module, AID.BigBangSpread, 5);
class BigCrunchPuddle(BossModule module) : Components.LocationTargetedAOEs(module, AID.BigCrunchAOE, 5);
