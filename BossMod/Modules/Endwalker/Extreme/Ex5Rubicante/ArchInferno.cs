...
class InfernoDevilFirst(BossModule module) : Components.SelfTargetedAOEs(module, AID.InfernoDevilFirst, new AOEShapeCircle(10));
class InfernoDevilRest(BossModule module) : Components.SelfTargetedAOEs(module, AID.InfernoDevilRest, new AOEShapeCircle(10));
class Conflagration(BossModule module) : Components.SelfTargetedAOEs(module, AID.Conflagration, new AOEShapeRect(20, 5, 20));
