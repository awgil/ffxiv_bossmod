...
class SecretBreezeCones(BossModule module) : Components.SelfTargetedAOEs(module, AID.SecretBreezeAOE, new AOEShapeCone(40, 22.5f.Degrees()));
...
class WarningGale(BossModule module) : Components.SelfTargetedAOEs(module, AID.WarningGale, new AOEShapeCircle(6));
...
class Boulder(BossModule module) : Components.LocationTargetedAOEs(module, AID.Boulder, 10);
class BrittleBoulder(BossModule module) : Components.SpreadFromCastTargets(module, AID.BrittleBoulder, 5);
class TornadoChainInner(BossModule module) : Components.SelfTargetedAOEs(module, AID.TornadoChainInner, new AOEShapeCircle(11));
class TornadoChainOuter(BossModule module) : Components.SelfTargetedAOEs(module, AID.TornadoChainOuter, new AOEShapeDonut(11, 20));
...
class BlowAwayPuddle(BossModule module) : Components.SelfTargetedAOEs(module, AID.BlowAwayPuddle, new AOEShapeCircle(6));
class ImpactAOE(BossModule module) : Components.SelfTargetedAOEs(module, AID.ImpactAOE, new AOEShapeCircle(6));
class ImpactKnockback(BossModule module) : Components.KnockbackFromCastTarget(module, AID.ImpactKnockback, 6);
class BlusteryRuler(BossModule module) : Components.SelfTargetedAOEs(module, AID.BlusteryRuler, new AOEShapeCircle(6));
class DryBlowsRaidwide(BossModule module) : Components.CastCounter(module, AID.DryBlowsRaidwide);
class DryBlowsPuddle(BossModule module) : Components.LocationTargetedAOEs(module, AID.DryBlowsPuddle, 3);
