...
public abstract class C013Shadowcaster(ModuleArgs init) : BossModule(init, new(289, -105), new ArenaBoundsRect(15, 20));
...
public class C013NShadowcaster(ModuleArgs init) : C013Shadowcaster(init);
...
public class C013SShadowcaster(ModuleArgs init) : C013Shadowcaster(init);
