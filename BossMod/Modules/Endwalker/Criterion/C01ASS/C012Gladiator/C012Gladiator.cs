...
public abstract class C012Gladiator(ModuleArgs init) : BossModule(init, new(-35, -271), new ArenaBoundsSquare(20));
...
public class C012NGladiator(ModuleArgs args) : C012Gladiator(args);
...
public class C012SGladiator(ModuleArgs args) : C012Gladiator(args);
