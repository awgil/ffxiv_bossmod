...
class RingOfMight1Out(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeCircle(8));
...
class RingOfMight2Out(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeCircle(13));
...
class RingOfMight3Out(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeCircle(18));
...
class RingOfMight1In(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeDonut(8, 30));
...
class RingOfMight2In(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeDonut(13, 30));
...
class RingOfMight3In(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeDonut(18, 30));
