...
class FizzlingDuster(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, C011Silkie.ShapeYellow);
...
class SqueakyCleanE(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, new AOEShapeCone(60, 112.5f.Degrees()));
...
class SqueakyCleanW(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, new AOEShapeCone(60, 112.5f.Degrees()));
...
class ChillingDusterPuff(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, C011Silkie.ShapeBlue);
...
class BracingDusterPuff(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, C011Silkie.ShapeGreen);
...
class FizzlingDusterPuff(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, C011Silkie.ShapeYellow);
