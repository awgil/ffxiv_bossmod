namespace BossMod.Endwalker.Criterion.C02AMR.C023Moko
{
    ...
    public enum AID : uint
    {
        ...
        STripleKasumiGiriInFrontFirst = 34280, // SBoss->self, 12.0s cast, range 60 270-degree cone
        STripleKasumiGiriInRightFirst = 34281, // SBoss->self, 12.0s cast, range 60 270-degree cone
        STripleKasumiGiriInBackFirst = 34282, // SBoss->self, 12.0s cast, range 60 270-degree cone
        STripleKasumiGiriInLeftFirst = 34283, // SBoss->self, 12.0s cast, range 60 270-degree cone
        STripleKasumiGiriOutFrontRest = 34286, // SBoss->self, 1.0s cast, range 60 270-degree cone
        STripleKasumiGiriOutRightRest = 34287, // SBoss->self, 1.0s cast, range 60 270-degree cone
        STripleKasumiGiriOutBackRest = 34288, // SBoss->self, 1.0s cast, range 60 270-degree cone
        STripleKasumiGiriOutLeftRest = 34289, // SBoss->self, 1.0s cast, range 60 270-degree cone
