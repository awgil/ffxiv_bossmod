...
public abstract class C023Moko(ModuleArgs init) : BossModule(init, new(-200, 0), new ArenaBoundsSquare(20));
...
public class C023NMoko(ModuleArgs args) : C023Moko(args);
...
public class C023SMoko(ModuleArgs args) : C023Moko(args);
