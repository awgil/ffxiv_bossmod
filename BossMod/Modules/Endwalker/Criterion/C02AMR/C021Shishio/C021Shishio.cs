...
public abstract class C021Shishio(ModuleArgs init) : BossModule(init, new(0, -100), new ArenaBoundsSquare(20));
...
public class C021NShishio(ModuleArgs args) : C021Shishio(args);
...
public class C021SShishio(ModuleArgs args) : C021Shishio(args);
