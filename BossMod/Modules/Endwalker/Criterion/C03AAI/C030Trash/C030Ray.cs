...
class Hydrocannon(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeRect(15, 3));
...
class Expulsion(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeCircle(8));
...
class ElectricWhorl(BossModule module, AID aid) : Components.StandardAOEs(module, aid, new AOEShapeDonut(8, 60));
...
public class C030NRay(ModuleArgs args) : C030Trash1(args)
{
...
public class C030SRay(ModuleArgs args) : C030Trash1(args)
{
    protected override void DrawEnemies(int pcSlot, Actor pc)
    {
        Arena.Actor(PrimaryActor, ArenaColor.Enemy);
