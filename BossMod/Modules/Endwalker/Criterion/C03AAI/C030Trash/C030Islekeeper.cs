...
[ModuleInfo(PrimaryActorOID = (uint)OID.NIslekeeper, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 979, NameID = 12561)]
public class C030NIslekeeper : C030Trash2
{
    public C030NIslekeeper(WorldState ws, Actor primary) : base(ws, primary) { }
}

[ModuleInfo(PrimaryActorOID = (uint)OID.SIslekeeper, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 980, NameID = 12561)]
