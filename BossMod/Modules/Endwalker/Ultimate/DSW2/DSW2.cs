...
class P2AscalonsMercyConcealed(BossModule module) : Components.SelfTargetedAOEs(module, AID.AscalonsMercyConcealedAOE, new AOEShapeCone(50, 15.Degrees()));
...
class P3Drachenlance(BossModule module) : Components.SelfTargetedAOEs(module, AID.DrachenlanceAOE, new AOEShapeCone(13, 45.Degrees()));
...
class P5TwistingDive(BossModule module) : Components.SelfTargetedAOEs(module, AID.TwistingDive, new AOEShapeRect(60, 5));
class P5Cauterize1(BossModule module) : Components.SelfTargetedAOEs(module, AID.Cauterize1, new AOEShapeRect(48, 10));
class P5Cauterize2(BossModule module) : Components.SelfTargetedAOEs(module, AID.Cauterize2, new AOEShapeRect(48, 10));
class P5SpearOfTheFury(BossModule module) : Components.SelfTargetedAOEs(module, AID.SpearOfTheFuryP5, new AOEShapeRect(50, 5));
...
class P6SwirlingBlizzard(BossModule module) : Components.SelfTargetedAOEs(module, AID.SwirlingBlizzard, new AOEShapeDonut(20, 35));
