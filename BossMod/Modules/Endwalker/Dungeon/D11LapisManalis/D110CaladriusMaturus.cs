...
class TransonicBlast(BossModule module) : Components.StandardAOEs(module, AID.TransonicBlast, new AOEShapeCone(9, 45.Degrees()));
...
public class D110CaladriusMaturus(ModuleInitializer init) : BossModule(init, new(47, -570.5f), new ArenaBoundsRect(8.5f, 11.5f))
{
