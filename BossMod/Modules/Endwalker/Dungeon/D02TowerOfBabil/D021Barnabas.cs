...
class Cleave(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, new AOEShapeRect(40, 3));
...
class Circles(BossModule module, AID aid) : Components.SelfTargetedAOEs(module, aid, new AOEShapeCircle(8));
