...
class Prance(BossModule module) : Components.SelfTargetedAOEs(module, AID.LamellarLight, new AOEShapeCircle(15), maxCasts: 3);
class Lifesbreath(BossModule module) : Components.SelfTargetedAOEs(module, AID.Lifesbreath, new AOEShapeRect(50, 5));
class LamellarLight(BossModule module) : Components.SelfTargetedAOEs(module, AID.LamellarLightRect, new AOEShapeRect(40, 2));
...
class LovingEmbrace(BossModule module) : Components.SelfTargetedAOEs(module, AID.LovingEmbrace, new AOEShapeCone(45, 90.Degrees()));
