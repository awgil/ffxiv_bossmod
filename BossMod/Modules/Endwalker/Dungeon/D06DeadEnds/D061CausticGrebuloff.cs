...
class CravenCompanionship(BossModule module) : BossComponent(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        {
            var nearestAlly = Raid.WithoutSlot().Exclude(actor).MinBy(p => p.DistanceToHitbox(actor));
            if (nearestAlly != null)
...
[ModuleInfo(BossModuleInfo.Maturity.WIP, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 792, NameID = 10313)]
