...
class Devour(BossModule module) : Components.CastHint(module, AID.Devour, "Harmless unless you got minimized by the previous mechanic");
class BogBomb(BossModule module) : Components.StandardAOEs(module, AID.BogBomb, 6);
class BrackishRain(BossModule module) : Components.StandardAOEs(module, AID.BrackishRain, new AOEShapeCone(10, 45.Degrees()));
...
public class Yilan(ModuleArgs init) : SimpleBossModule(init);
