...
class LayOfMislaidMemory(BossModule module) : Components.StandardAOEs(module, AID.LayOfMislaidMemory, new AOEShapeCone(30, 60.Degrees()));
class TempestuousWrath(BossModule module) : Components.ChargeAOEs(module, AID.TempestuousWrath, 4);
class RottingElegy(BossModule module) : Components.StandardAOEs(module, AID.RottingElegy, new AOEShapeDonut(5, 50));
...
public class Hulder(ModuleArgs init) : SimpleBossModule(init);
