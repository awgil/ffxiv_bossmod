...
class PandaemonsHoly(BossModule module) : Components.SelfTargetedAOEs(module, AID.PandaemonsHoly, new AOEShapeCircle(36));

// note: origin seems to be weird?
class CirclesOfPandaemonium(BossModule module) : Components.SelfTargetedAOEs(module, AID.CirclesOfPandaemonium, new AOEShapeDonut(12, 40))
{
...
class Imprisonment(BossModule module) : Components.SelfTargetedAOEs(module, AID.ImprisonmentAOE, new AOEShapeCircle(4));
class Cannonspawn(BossModule module) : Components.SelfTargetedAOEs(module, AID.CannonspawnAOE, new AOEShapeDonut(3, 8));
class PealOfDamnation(BossModule module) : Components.SelfTargetedAOEs(module, AID.PealOfDamnation, new AOEShapeRect(50, 3.5f));
class PandaemoniacPillars(BossModule module) : Components.CastTowers(module, AID.Bury, 2);
class Touchdown(BossModule module) : Components.SelfTargetedAOEs(module, AID.TouchdownAOE, new AOEShapeCircle(20));
