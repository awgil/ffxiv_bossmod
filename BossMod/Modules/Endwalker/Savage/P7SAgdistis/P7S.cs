...
class BoughOfAttisBack(BossModule module) : Components.SelfTargetedAOEs(module, AID.BoughOfAttisBackAOE, new AOEShapeCircle(25));
class BoughOfAttisFront(BossModule module) : Components.SelfTargetedAOEs(module, AID.BoughOfAttisFrontAOE, new AOEShapeCircle(19));
class BoughOfAttisSide(BossModule module) : Components.SelfTargetedAOEs(module, AID.BoughOfAttisSideAOE, new AOEShapeRect(50, 12.5f));
...
class HemitheosTornado(BossModule module) : Components.SelfTargetedAOEs(module, AID.HemitheosTornado, new AOEShapeCircle(25));
class HemitheosGlareMine(BossModule module) : Components.SelfTargetedAOEs(module, AID.HemitheosGlareMine, new AOEShapeDonut(5, 30)); // TODO: verify inner radius
