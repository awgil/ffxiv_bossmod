...
{
    public static readonly ArenaBoundsRect DefaultBounds = new ArenaBoundsRect(new(100, 95), 20, 15);
    public static readonly ArenaBoundsCircle SmallBounds = new ArenaBoundsCircle(new(100, 90), 7);
}
