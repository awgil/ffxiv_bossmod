...
public class A30Trash2Pack1(ModuleInitializer init) : BossModule(init, new(800, 770), new ArenaBoundsRect(15, 25))
{
...
public class A30Trash2Pack2(ModuleInitializer init) : BossModule(init, new(800, 910), new ArenaBoundsSquare(20))
{
    protected override void DrawEnemies(int pcSlot, Actor pc)
    {
