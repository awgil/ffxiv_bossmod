...
class SummerShade(BossModule module) : Components.SelfTargetedAOEs(module, AID.SummerShade, new AOEShapeDonut(12, 40));
class SpringFlowers(BossModule module) : Components.SelfTargetedAOEs(module, AID.SpringFlowers, new AOEShapeCircle(12));
class ReapersGale(BossModule module) : Components.SelfTargetedAOEs(module, AID.ReapersGaleAOE, new AOEShapeRect(36, 4, 36), 9);
class Landwaker(BossModule module) : Components.LocationTargetedAOEs(module, AID.LandwakerAOE, 10);
