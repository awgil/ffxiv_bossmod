...
class WrathOfHalone(BossModule module) : Components.SelfTargetedAOEs(module, AID.WrathOfHaloneAOE, new AOEShapeCircle(25)); // TODO: verify falloff
...
class Niphas(BossModule module) : Components.SelfTargetedAOEs(module, AID.Niphas, new AOEShapeCircle(9));
