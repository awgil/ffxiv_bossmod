...
class RheognosisKnockback(BossModule module) : Components.Knockback(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        if ((AID)spell.Action.ID is AID.Rheognosis or AID.RheognosisPetrine)
            _knockback = new(Module.Center, 25, spell.NPCFinishAt.AddSeconds(20.3f), Direction: spell.Rotation + 180.Degrees(), Kind: Kind.DirForward);
    }
...
public class RheognosisCrash(BossModule module) : Components.Exaflare(module, new AOEShapeRect(24.01f, 12), ActionID.MakeSpell(AID.RheognosisCrash))
{
