...
class BrokenWorld() : Components.SelfTargetedAOEs(ActionID.MakeSpell(AID.BrokenWorldAOE), new AOEShapeCircle(30)); // TODO: determine falloff
...
class LightningStorm() : Components.SpreadFromCastTargets(ActionID.MakeSpell(AID.LightningStorm), 5);