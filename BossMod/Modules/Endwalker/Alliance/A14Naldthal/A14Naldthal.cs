...
class HellOfFireFront(BossModule module) : Components.SelfTargetedAOEs(module, AID.HellOfFireFrontAOE, new AOEShapeCone(60, 90.Degrees()));
class HellOfFireBack(BossModule module) : Components.SelfTargetedAOEs(module, AID.HellOfFireBackAOE, new AOEShapeCone(60, 90.Degrees()));
class WaywardSoul(BossModule module) : Components.SelfTargetedAOEs(module, AID.WaywardSoulAOE, new AOEShapeCircle(18), 3);
class SoulVessel(BossModule module) : Components.Adds(module, (uint)OID.SoulVesselReal);
class Twingaze(BossModule module) : Components.SelfTargetedAOEs(module, AID.Twingaze, new AOEShapeCone(60, 15.Degrees()));
