...
namespace BossMod.Endwalker.Alliance.A35Eulogia
{
    class Quintessence : Components.GenericAOEs
    {
        ...
        private Dictionary<AID, DateTime> _formToEffectTiming = new();

        public override IEnumerable<AOEInstance> ActiveAOEs(BossModule module, int slot, Actor actor) => _aoes.Take(3);
        ...
        private AOEShape? DetermineShape(AID actionID)
        {
            ...
            {
                AID.QuintessenceFirstAOE or AID.QuintessenceSecondAOE or AID.QuintessenceThirdAOE => new AOEShapeDonut(10, 60),
