...
class HandOfTheDestroyerWrath(BossModule module) : Components.SelfTargetedAOEs(module, AID.HandOfTheDestroyerWrathAOE, new AOEShapeRect(90, 20));
class HandOfTheDestroyerJudgment(BossModule module) : Components.SelfTargetedAOEs(module, AID.HandOfTheDestroyerJudgmentAOE, new AOEShapeRect(90, 20));
class SoaringMinuet(BossModule module) : Components.SelfTargetedAOEs(module, AID.SoaringMinuet, new AOEShapeCone(40, 135.Degrees()));
