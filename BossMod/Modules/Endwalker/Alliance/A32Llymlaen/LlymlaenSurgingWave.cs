...
class SurgingWaveKnockback : Components.KnockbackFromCastTarget
{
    public SurgingWaveKnockback() : base(ActionID.MakeSpell(AID.SurgingWaveKnockback), 40, kind: Kind.AwayFromOrigin) { }
}