    ...
    public enum AID : uint
{
    ...
    TempestRaidwide = 34827, // Llymlaen->self, 5.0s cast, range 100 circle // Raidwide
    ShockwaveRaidwide = 34836, // LlymlaenHelper->self, 10.2s cast, range 100 circle // Raidwide
    LandingRaidwide = 34843, // Trident->self, no cast, range 80 circle // Raidwide
    GodsbaneRaidwide = 35948, // LlymlaenHelper->self, 7.0s cast, range 100 circle // Raidwide
    
    SeafoamSpiralDonut = 34829, // Llymlaen->self, 6.0s cast, range 7-70 donut // DonutAOE
    
    WindRoseAOE = 34828, // Llymlaen->self, 6.0s cast, range 12 circle // CircleAOE
    
    DireStraitAltVisual = 34825, // Llymlaen->location, no cast, single-target // Visual
    DireStraitAltRectAOE1 = 36045, // LlymlaenHelper->self, 2.5s cast, range 40 width 80 rect // RectAOE
    DireStraitAltRectAOE2 = 36046, // LlymlaenHelper->self, 4.5s cast, range 40 width 80 rect // RectAOE
    
    DireStraitsVisual = 36044, // Llymlaen->self, no cast, single-target // Visual
    DireStraitsRectAOE1 = 34831, // LlymlaenHelper->self, 7.5s cast, range 40 width 80 rect // RectAOE
    DireStraitsRectAOE2 = 34832, // LlymlaenHelper->self, 9.3s cast, range 40 width 80 rect // RectAOE
    
    _Ability4_ = 34859, // Llymlaen->self, no cast, single-target
    
    NavigatorsTridentVisual1 = 34830, // Llymlaen->self, 6.5s cast, single-target
    NavigatorsTridentVisual2 = 36048, // Llymlaen->self, no cast, single-target
    NavigatorsTridentRectAOE = 34833, // LlymlaenHelper->self, 7.0s cast, range 60 width 60 rect // RectAOE with knockback
...
{
    VulnerabilityUp = 1789, // Llymlaen/SeaFoam/LlymlaenHelper/Trident/Perykos/Thalaos->player, extra=0x1/0x2/0x3/0x4/0x5
