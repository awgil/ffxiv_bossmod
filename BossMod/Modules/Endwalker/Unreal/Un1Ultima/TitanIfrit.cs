...
namespace BossMod.Endwalker.Unreal.Un1Ultima
{
    ...
    class TitanIfrit : BossModule.Component
    {
        ...
        {
            if (_activeLocationTargetedAOEs.Any(e => e.Item2.Check(actor.Position, e.Item1.CastInfo!.Location, 0)) || _crimsonCyclone.Any(a => _aoeCrimsonCyclone.Check(actor.Position, a)))
        ...
        public override void DrawArenaBackground(BossModule module, int pcSlot, Actor pc, MiniArena arena)
        {
            foreach (var (a, aoe) in _activeLocationTargetedAOEs)
                aoe.Draw(arena, a.CastInfo!.Location, 0);
