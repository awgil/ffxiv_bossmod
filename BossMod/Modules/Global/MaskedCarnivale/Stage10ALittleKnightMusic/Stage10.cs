...
class KingsWill2(BossModule module) : Components.CastHint(module, ActionID.MakeSpell(AID.KingsWill2), KingsWill1.hints);

class KingsWill3(BossModule module) : Components.CastHint(module, ActionID.MakeSpell(AID.KingsWill3), KingsWill1.hints);
