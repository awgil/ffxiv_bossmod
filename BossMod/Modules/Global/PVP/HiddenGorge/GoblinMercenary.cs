...
public class GoblinMercenary(ModuleArgs init) : BossModule(init, new(0, init.Primary.Position.Z < 0 ? -124.5f : 144.5f), init.Primary.Position.Z < 0 ? new ArenaBoundsSquare(16) : new ArenaBoundsCircle(30));
