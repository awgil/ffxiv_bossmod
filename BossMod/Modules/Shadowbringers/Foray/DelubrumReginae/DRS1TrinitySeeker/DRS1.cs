...
class BalefulOnslaught1(BossModule module) : Components.Cleave(module, AID.BalefulOnslaughtAOE1, new AOEShapeCone(10, 45.Degrees())); // TODO: verify angle
class BalefulOnslaught2(BossModule module) : Components.Cleave(module, AID.BalefulOnslaughtAOE2, new AOEShapeCone(10, 45.Degrees())); // TODO: verify angle

class BurningChains(BossModule module) : Components.Chains(module, (uint)TetherID.BurningChains, AID.ScorchingShackle);
...
{
    public DeadIron(BossModule module) : base(module, new AOEShapeCone(50, 15.Degrees()), (uint)TetherID.DeadIron, AID.DeadIronAOE) { DrawTethers = false; }
}

[ModuleInfo(BossModuleInfo.Maturity.Verified, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 761, NameID = 9834, PlanLevel = 80)]
public class DRS1(ModuleInitializer init) : BossModule(init, new(0, 278), new ArenaBoundsCircle(25))
{
