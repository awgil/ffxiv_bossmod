...
public class DRS8(ModuleInitializer init) : BossModule(init, new(-272, -415), new ArenaBoundsCircle(25)); // note: initially arena is square, but it quickly changes to circle
