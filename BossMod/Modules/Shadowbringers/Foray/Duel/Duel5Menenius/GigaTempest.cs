...
internal abstract class GigaTempest : Exaflare
{
    private static AOEShapeRect _aoeShapeSmall = new(10, 6.5f, 0);
    private static AOEShapeRect _aoeShapeLarge = new(35, 6.5f, 0);

    internal class SmallGigaTempest : GigaTempest
    {
    ...
    internal class LargeGigaTempest : GigaTempest
    {
