...
class LightningRod(BossModule module) : BossComponent(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        {
            var mineShape = ShapeContains.Union([.. Mines.Select(m => ShapeContains.Circle(m, Radius))]);
...
[ModuleInfo(GroupType = BossModuleInfo.GroupType.BozjaCE, GroupID = 735, NameID = 10)] // bnpcname=9417
