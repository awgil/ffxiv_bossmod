...
namespace BossMod.Shadowbringers.Foray.CriticalEngagement.CE12BayingOfHounds
{
    ...
    {
        public TheDragonsBreathA() : base(ActionID.MakeSpell(AID.TheDragonsBreathA), new AOEShapeCone(60, 35.Degrees(), -10.Degrees())) { }
    }
    ...
    {
        public LionsBreath() : base(ActionID.MakeSpell(AID.LionsBreathAOE), new AOEShapeCone(60, 39.Degrees())) { } // TODO: verify angle
    }
