...
namespace BossMod.Shadowbringers.Foray.CriticalEngagement.CE42FromBeyondTheGrave
{
    ...
    {
        public MarchingBreath() : base(ActionID.MakeSpell(AID.MarchingBreath), hintExtra: "(20% HP AOE heal)") { }
    }
    ...
    {
        public SoulSacrifice() : base(ActionID.MakeSpell(AID.SoulSacrifice), hintExtra: "(Dmg buff on boss)") { }
    }
