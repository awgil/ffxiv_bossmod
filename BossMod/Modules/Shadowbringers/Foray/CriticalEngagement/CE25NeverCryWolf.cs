...
class BracingWind(BossModule module) : Components.KnockbackFromCastTarget(module, AID.BracingWind, 40, false, 1, new AOEShapeRect(60, 6), Kind.DirForward)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        {
            hints.AddForbiddenZone(ShapeContains.Rect(c.Position, c.CastInfo!.Rotation, length, Distance - length, 6), Module.CastFinishAt(c.CastInfo!));
        }
    }
}
...
public class Hrodvitnir : BossModule
{
    ...
    public Hrodvitnir(ModuleInitializer init) : base(init, new(-830, 190), new ArenaBoundsSquare(24))
    {
