...
class OdiousMiasma(BossModule module) : Components.StandardAOEs(module, AID.OdiousMiasma, new AOEShapeCone(12, 60.Degrees()));
...
[ModuleInfo(Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.Hunt, GroupID = (uint)BossModuleInfo.HuntRank.A, NameID = 8907)]
