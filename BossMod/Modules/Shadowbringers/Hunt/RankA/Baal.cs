...
class SewerWater(BossModule module) : Components.StandardAOEs(module, AID.SewerWater, new AOEShapeCone(12, 90.Degrees()));
class SewerWater2(BossModule module) : Components.StandardAOEs(module, AID.SewerWater2, new AOEShapeCone(12, 90.Degrees()));
...
public class Baal(ModuleArgs args) : SimpleBossModule(args) { }
