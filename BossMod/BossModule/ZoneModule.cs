...
public abstract class ZoneModule(WorldState ws) : IDisposable
{
    ...
    public virtual bool WantDrawHints() => false; // return true if it wants to be drawn (higher priority than inactive boss modules, but lower priority than active)
    public virtual bool WantDrawExtra() => false;
    public virtual List<string> CalculateGlobalHints() => [];
    public virtual void BeforeCalculateAIHints(int playerSlot, Actor player, AIHints hints) { }
