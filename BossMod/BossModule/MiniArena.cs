...
public sealed class MiniArena(BossModuleConfig config, StandardColors colors, WPos center, ArenaBounds bounds)
{
    public readonly BossModuleConfig Config = config;
    public readonly StandardColors ArenaColor = colors;
