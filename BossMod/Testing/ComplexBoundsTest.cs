...
class ComplexBoundsTest : TestWindow
{
    ...
    private readonly StandardColors _colors;

    public ComplexBoundsTest(StandardColors colors) : base("Complex bounds test", new(800, 800), ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse)
    {
        _colors = colors;
        _arena = RebuildArena();
    }
    ...
    public override void Draw()
    {
        ...
        _arena.Border(_colors.Border);

        var t1 = DateTime.Now;
        _arena.ZoneCircle(_arena.Center + _aoeOffset * _aoeRotDeg.Degrees().ToDirection(), _aoeRadius, _colors.AOE);
    ...
    private MiniArena RebuildArena()
    {
        ...
        return new(new(), _colors, new(100, 100), new ArenaBoundsCustom(40, bounds));
    }
