...
class MiniArenaTest(StandardColors colors) : TestWindow("Arena test", new(400, 400), ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse)
{
    private readonly MiniArena _arena = new(new(), colors, new(100, 100), new ArenaBoundsSquare(20));
