...
namespace BossMod
{
    ...
    public static class CurveApprox
    {
        ...
        public static int CalculateCircleSegments(float radius, float angularLength, float maxError = ScreenError)
        {
        ...
        public static IEnumerable<Vector2> Circle(Vector2 center, float radius, float maxError = ScreenError)
        {
        ...
        public static IEnumerable<Vector2> CircleArc(Vector2 center, float radius, float angleStart, float angleEnd, float maxError = ScreenError)
        {
        ...
        public static IEnumerable<Vector2> CircleSector(Vector2 center, float radius, float angleStart, float angleEnd, float maxError = ScreenError)
        {
            yield return center;
        ...
        public static IEnumerable<Vector2> DonutSector(Vector2 center, float innerRadius, float outerRadius, float angleStart, float angleEnd, float maxError = ScreenError)
        {
