...
namespace BossMod
{
    public static class Utils
    {
        ...
        public static unsafe byte CharacterAnimationState(Character chr, bool second) => ReadField<byte>(CharacterInternal(chr), 0x25C + (second ? 0x2C2 : 0x2C1)); // see actor control 62
        public static unsafe byte CharacterModelState(Character chr) => ReadField<byte>(CharacterInternal(chr), 0x25C + 0x2C0); // see actor control 63
