...
namespace BossMod
{
    ...
    class Protocol
    {
        public enum Opcode
        {
            ...
            StatusEffectListEureka = 0x03D0,
            StatusEffectListBozja = 0x03DE, // machina: StatusEffectList2
            StatusEffectListDouble = 0x035D, // machina: BossStatusEffectList
            EffectResult1 = 0x037B,
            EffectResult4 = 0x0105,
            EffectResult8 = 0x012E,
            EffectResult16 = 0x03C4,
            EffectResultBasic1 = 0x01FB,
            ...
            ActorControl = 0x01BB, // example: toggle weapon
            ActorControlSelf = 0x0228, // example: cooldown
            ActorControlTarget = 0x019D, // example: target change
            UpdateHpMpTp = 0x0394,
            ActionEffect1 = 0x00D4, // machina: AbilityN
            ActionEffect8 = 0x01A4,
            ActionEffect16 = 0x01C9,
            ActionEffect24 = 0x0252,
            ActionEffect32 = 0x02C8,
            StatusEffectListPlayer = 0x0123, // machina: StatusEffectList3
            UpdateRecastTimes = 0x0358,
            UpdateAllianceNormal = 0x0398,
            UpdateAllianceSmall = 0x021D,
            UpdatePartyMemberPositions = 0x0346,
            UpdateAllianceNormalMemberPositions = 0x03B5,
            UpdateAllianceSmallMemberPositions = 0x02F2,
            SpawnPlayer = 0x0100,
            SpawnNPC = 0x01C0,
            SpawnBoss = 0x0163,
            DespawnCharacter = 0x00CD,
            ActorMove = 0x00B4,
            ActorSetPos = 0x02E5,
            ActorCast = 0x0291,
            InitZone = 0x037D,
            ApplyIDScramble = 0x0140,
            UpdateHate = 0x017A,
            UpdateHater = 0x0205,
            SpawnObject = 0x01F4, // FFXIVOpcodes: ObjectSpawn
            UpdateClassInfo = 0x020A,
            UpdateClassInfoEureka = 0x01E9,
            UpdateClassInfoBozja = 0x0159,
            PlayerSetup = 0x027F,
            PlayerStats = 0x00EE,
            Examine = 0x03DC,
            RetainerInformation = 0x0168,
            ItemMarketBoardInfo = 0x0130,
            ItemInfo = 0x0220,
            ContainerInfo = 0x01AD,
            InventoryTransactionFinish = 0x035B,
            InventoryTransaction = 0x029F,
            CurrencyCrystalInfo = 0x0304,
            ...
            EventFinish = 0x039A,
            ResultDialog = 0x0125,
            DesynthResult = 0x01DA,
            EnvControl = 0x0126,
            SystemLogMessage1 = 0x00F7, // FFXIVOpcodes: SomeDirectorUnk4
            SystemLogMessage2 = 0x0082,
            SystemLogMessage4 = 0x00FC,
            SystemLogMessage8 = 0x0202,
            SystemLogMessage16 = 0x01AC,
            WeatherChange = 0x0371,
            AirshipTimers = 0x01E5,
            WaymarkPreset = 0x0090, // FFXIVOpcodes: PlaceFieldMarkerPreset, machina: PresetWaymark
            Waymark = 0x0160, // FFXIVOpcodes: PlaceFieldMarker
