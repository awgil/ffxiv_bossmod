...
class P2Hypernova(BossModule module) : Components.VoidzoneAtCastTarget(module, 5, AID.Hypernova, m => m.Enemies(OID.VoidzoneHypernova).Where(z => z.EventState != 7), 1.4f);
