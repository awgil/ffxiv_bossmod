...
class LiquidHell(BossModule module) : Components.VoidzoneAtCastTarget(module, 6, AID.LiquidHell, m => m.Enemies(OID.VoidzoneLiquidHell).Where(z => z.EventState != 7), 1.3f)
{
    bool BaitAtWall;
    DateTime NextCast;
