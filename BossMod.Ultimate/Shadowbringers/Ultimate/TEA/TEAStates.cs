...
class TEAStates : StateMachineBuilder
{
    ...
    private void P2MissileCommand(uint id, float delay)
    {
        ...
        ComponentCondition<P2EarthMissileIce>(id + 0x70, 0.8f, comp => comp.Sources.Any());
        ...
        ComponentCondition<P2EarthMissileIce>(id + 0x80, 9.8f, comp => !comp.Sources.Any(), "Voidzones disappear")
